-- ===========================================
-- POKEMON Y: COMPLETE GAME DATA
-- Official Pokemon Game
-- Gen 6, Kalos region
-- ===========================================
-- Game ID: e7f8a9b0-c1d2-3456-e789-012345678901
-- ===========================================
...
VALUES (
  'e7f8a9b0-c1d2-3456-e789-012345678901',
  'pokemon-y',
  'Pokemon Y',
  6,
  'Kalos',
  ...
  53,
  'Pokemon Y for Nintendo 3DS. Set in the Kalos region. Introduces Fairy type and Mega Evolution.'
);
...
('e7f8a9b0-c1d2-3456-e789-012345678901', 'Vaniville Town', 'vaniville-town', 1, 'city', true, false, false, 'Starter town. Choose Chespin, Fennekin, or Froakie.'),
('e7f8a9b0-c1d2-3456-e789-012345678901', 'Route 1 (Vaniville Pathway)', 'route-1', 2, 'route', false, false, false, 'Very short path to Aquacorde Town.'),
('e7f8a9b0-c1d2-3456-e789-012345678901', 'Aquacorde Town', 'aquacorde-town', 3, 'city', false, false, false, 'Meet friends and receive starter.'),
('e7f8a9b0-c1d2-3456-e789-012345678901', 'Route 2 (Avance Trail)', 'route-2', 4, 'route', true, true, false, NULL),
('e7f8a9b0-c1d2-3456-e789-012345678901', 'Santalune Forest', 'santalune-forest', 5, 'cave', true, true, true, NULL),
('e7f8a9b0-c1d2-3456-e789-012345678901', 'Route 3 (Ouvert Way)', 'route-3', 6, 'route', true, true, false, NULL),
('e7f8a9b0-c1d2-3456-e789-012345678901', 'Santalune City', 'santalune-city', 7, 'city', false, true, true, 'Gym Leader Viola. Bug-type specialist.'),
('e7f8a9b0-c1d2-3456-e789-012345678901', 'Route 4 (Parterre Way)', 'route-4', 8, 'route', true, true, false, 'Flower garden route.'),
('e7f8a9b0-c1d2-3456-e789-012345678901', 'Lumiose City (South)', 'lumiose-city-south', 9, 'city', false, false, true, 'Partial access. Full access after Clemont.'),
('e7f8a9b0-c1d2-3456-e789-012345678901', 'Route 5 (Versant Road)', 'route-5', 10, 'route', true, true, false, NULL),
('e7f8a9b0-c1d2-3456-e789-012345678901', 'Camphrier Town', 'camphrier-town', 11, 'city', false, false, true, NULL),
('e7f8a9b0-c1d2-3456-e789-012345678901', 'Route 6 (Palais Lane)', 'route-6', 12, 'route', true, true, false, NULL),
('e7f8a9b0-c1d2-3456-e789-012345678901', 'Parfum Palace', 'parfum-palace', 13, 'building', false, false, true, 'Furfrou event.'),
('e7f8a9b0-c1d2-3456-e789-012345678901', 'Route 7 (Rivière Walk)', 'route-7', 14, 'route', true, true, false, 'Berry fields.'),
('e7f8a9b0-c1d2-3456-e789-012345678901', 'Connecting Cave', 'connecting-cave', 15, 'cave', true, true, true, NULL),
('e7f8a9b0-c1d2-3456-e789-012345678901', 'Route 8 (Muraille Coast)', 'route-8', 16, 'route', true, true, false, 'Coastal route.'),
('e7f8a9b0-c1d2-3456-e789-012345678901', 'Ambrette Town', 'ambrette-town', 17, 'city', false, false, true, 'Fossil Lab.'),
('e7f8a9b0-c1d2-3456-e789-012345678901', 'Route 9 (Spikes Passage)', 'route-9', 18, 'route', true, true, false, 'Rhyhorn ride section.'),
('e7f8a9b0-c1d2-3456-e789-012345678901', 'Glittering Cave', 'glittering-cave', 19, 'cave', true, true, true, 'Team Flare encounter. Fossil restoration.'),
('e7f8a9b0-c1d2-3456-e789-012345678901', 'Cyllage City', 'cyllage-city', 20, 'city', false, true, true, 'Gym Leader Grant. Rock-type specialist.'),
('e7f8a9b0-c1d2-3456-e789-012345678901', 'Route 10 (Menhir Trail)', 'route-10', 21, 'route', true, true, false, 'Standing stones area.'),
('e7f8a9b0-c1d2-3456-e789-012345678901', 'Geosenge Town', 'geosenge-town', 22, 'city', false, false, true, 'Team Flare base nearby.'),
('e7f8a9b0-c1d2-3456-e789-012345678901', 'Route 11 (Miroir Way)', 'route-11', 23, 'route', true, true, false, NULL),
('e7f8a9b0-c1d2-3456-e789-012345678901', 'Reflection Cave', 'reflection-cave', 24, 'cave', true, true, true, NULL),
('e7f8a9b0-c1d2-3456-e789-012345678901', 'Shalour City', 'shalour-city', 25, 'city', false, true, true, 'Gym Leader Korrina. Fighting-type specialist.'),
('e7f8a9b0-c1d2-3456-e789-012345678901', 'Tower of Mastery', 'tower-of-mastery', 26, 'building', false, true, false, 'Mega Evolution tutorial. Lucario gift.'),
('e7f8a9b0-c1d2-3456-e789-012345678901', 'Route 12 (Fourrage Road)', 'route-12', 27, 'route', true, true, false, 'Lapras gift.'),
('e7f8a9b0-c1d2-3456-e789-012345678901', 'Coumarine City', 'coumarine-city', 28, 'city', false, true, true, 'Gym Leader Ramos. Grass-type specialist.'),
('e7f8a9b0-c1d2-3456-e789-012345678901', 'Route 13 (Lumiose Badlands)', 'route-13', 29, 'route', true, true, false, 'Desert area. Power Plant nearby.'),
('e7f8a9b0-c1d2-3456-e789-012345678901', 'Lumiose City', 'lumiose-city', 30, 'city', false, true, true, 'Gym Leader Clemont. Electric-type specialist. Full city access.'),
('e7f8a9b0-c1d2-3456-e789-012345678901', 'Route 14 (Laverre Nature Trail)', 'route-14', 31, 'route', true, true, false, 'Swampy forest.'),
('e7f8a9b0-c1d2-3456-e789-012345678901', 'Laverre City', 'laverre-city', 32, 'city', false, true, true, 'Gym Leader Valerie. Fairy-type specialist.'),
('e7f8a9b0-c1d2-3456-e789-012345678901', 'Poke Ball Factory', 'poke-ball-factory', 33, 'building', false, true, true, 'Team Flare encounter.'),
('e7f8a9b0-c1d2-3456-e789-012345678901', 'Route 15 (Brun Way)', 'route-15', 34, 'route', true, true, false, NULL),
('e7f8a9b0-c1d2-3456-e789-012345678901', 'Lost Hotel', 'lost-hotel', 35, 'building', true, true, true, NULL),
('e7f8a9b0-c1d2-3456-e789-012345678901', 'Route 16 (Melancolie Path)', 'route-16', 36, 'route', true, true, false, NULL),
('e7f8a9b0-c1d2-3456-e789-012345678901', 'Dendemille Town', 'dendemille-town', 37, 'city', false, false, true, NULL),
('e7f8a9b0-c1d2-3456-e789-012345678901', 'Frost Cavern', 'frost-cavern', 38, 'cave', true, true, true, 'Team Flare encounter. Abomasnow battle.'),
('e7f8a9b0-c1d2-3456-e789-012345678901', 'Route 17 (Mamoswine Road)', 'route-17', 39, 'route', true, true, false, 'Mamoswine ride through deep snow.'),
('e7f8a9b0-c1d2-3456-e789-012345678901', 'Anistar City', 'anistar-city', 40, 'city', false, true, true, 'Gym Leader Olympia. Psychic-type specialist.'),
('e7f8a9b0-c1d2-3456-e789-012345678901', 'Route 18 (Vallée Étroite Way)', 'route-18', 41, 'route', true, true, false, NULL),
('e7f8a9b0-c1d2-3456-e789-012345678901', 'Terminus Cave', 'terminus-cave', 42, 'cave', true, true, true, 'Zygarde encounter (post-game).'),
('e7f8a9b0-c1d2-3456-e789-012345678901', 'Couriway Town', 'couriway-town', 43, 'city', false, false, true, NULL),
('e7f8a9b0-c1d2-3456-e789-012345678901', 'Route 19 (Grande Vallée Way)', 'route-19', 44, 'route', true, true, false, NULL),
('e7f8a9b0-c1d2-3456-e789-012345678901', 'Snowbelle City', 'snowbelle-city', 45, 'city', false, true, true, 'Gym Leader Wulfric. Ice-type specialist.'),
('e7f8a9b0-c1d2-3456-e789-012345678901', 'Route 20 (Winding Woods)', 'route-20', 46, 'route', true, true, false, NULL),
('e7f8a9b0-c1d2-3456-e789-012345678901', 'Pokemon Village', 'pokemon-village', 47, 'special', true, false, true, 'Hidden area with rare Pokemon.'),
('e7f8a9b0-c1d2-3456-e789-012345678901', 'Route 21 (Dernière Way)', 'route-21', 48, 'route', true, true, false, NULL),
('e7f8a9b0-c1d2-3456-e789-012345678901', 'Victory Road', 'victory-road', 49, 'cave', true, true, true, NULL),
('e7f8a9b0-c1d2-3456-e789-012345678901', 'Pokemon League', 'pokemon-league', 50, 'building', false, true, false, 'Elite Four and Champion Diantha.'),
('e7f8a9b0-c1d2-3456-e789-012345678901', 'Kiloude City', 'kiloude-city', 51, 'city', false, true, true, 'Battle Maison. Friend Safari.'),
('e7f8a9b0-c1d2-3456-e789-012345678901', 'Route 22 (Détourner Way)', 'route-22', 52, 'route', true, true, false, NULL),
('e7f8a9b0-c1d2-3456-e789-012345678901', 'Chamber of Emptiness', 'chamber-of-emptiness', 53, 'cave', false, false, true, 'Banettite found here.');
...
FROM public.routes r WHERE r.slug = 'vaniville-town' AND r.game_id = 'e7f8a9b0-c1d2-3456-e789-012345678901';
...
('route-2', 10, 'walking', 11.00, 3, 4, NULL, NULL),
...
('santalune-forest', 10, 'walking', 20.00, 2, 3, NULL, NULL),
('santalune-forest', 11, 'walking', 4.00, 4, 4, NULL, NULL),
('santalune-forest', 13, 'walking', 10.00, 2, 2, NULL, NULL),
...
('route-5', 312, 'walking', 10.00, 9, 10, NULL, NULL),
...
('route-7', 682, 'walking', 30.00, 14, 14, NULL, NULL),
...
('route-8', 90, 'fishing_good', 35.00, 25, 25, NULL, NULL),
('route-8', 91, 'fishing_super', 5.00, 35, 35, NULL, NULL),
...
('route-8', 336, 'walking', 20.00, 14, 14, NULL, NULL),
...
('route-8', 557, 'rock_smash', 66.00, 13, 15, NULL, NULL),
('route-8', 619, 'walking', 40.00, 13, 15, NULL, NULL),
('route-8', 686, 'walking', 30.00, 14, 15, NULL, NULL),
('route-8', 688, 'rock_smash', 34.00, 13, 15, NULL, NULL),
('route-8', 690, 'fishing_good', 65.00, 25, 25, NULL, NULL),
('route-8', 691, 'fishing_super', 35.00, 35, 35, NULL, NULL),
...
('route-10', 309, 'walking', 30.00, 19, 21, NULL, NULL),
...
('route-11', 538, 'walking', 20.00, 22, 23, NULL, NULL),
...
('route-12', 214, 'walking', 10.00, 25, 27, NULL, NULL),
...
('route-12', 368, 'fishing_super', 5.00, 35, 35, NULL, NULL),
...
('route-15', 510, 'walking', 40.00, 34, 36, NULL, NULL),
('route-15', 550, 'fishing_good', 65.00, 25, 25, NULL, NULL),
...
('route-15', 10016, 'fishing_super', 35.00, 35, 35, NULL, NULL),
...
('route-16', 550, 'fishing_good', 65.00, 25, 25, NULL, NULL),
...
('route-16', 10016, 'fishing_super', 35.00, 35, 35, NULL, NULL),
...
('frost-cavern', 550, 'fishing_good', 130.00, 30, 30, NULL, NULL),
('frost-cavern', 10016, 'fishing_super', 70.00, 40, 40, NULL, NULL),
('frost-cavern', 93, 'walking', 68.00, 38, 40, NULL, NULL),
...
('frost-cavern', 615, 'walking', 12.00, 40, 40, NULL, NULL),
...
('route-18', 247, 'walking', 40.00, 44, 46, NULL, NULL),
...
('terminus-cave', 247, 'walking', 80.00, 45, 46, NULL, NULL),
...
('pokemon-village', 550, 'fishing_good', 65.00, 40, 40, NULL, NULL),
...
('pokemon-village', 10016, 'fishing_super', 35.00, 50, 50, NULL, NULL),
...
('victory-road', 550, 'fishing_good', 195.00, 45, 45, NULL, NULL),
('victory-road', 621, 'walking', 80.00, 58, 59, NULL, NULL),
('victory-road', 634, 'walking', 20.00, 59, 59, NULL, NULL),
('victory-road', 10016, 'fishing_super', 105.00, 55, 55, NULL, NULL),
...
FROM _enc e JOIN public.routes r ON r.slug = e.slug AND r.game_id = 'e7f8a9b0-c1d2-3456-e789-012345678901';
...
DECLARE
  ...
  v_route_id UUID;
BEGIN
  SELECT id INTO v_route_id FROM public.routes WHERE slug = 'santalune-city' AND game_id = 'e7f8a9b0-c1d2-3456-e789-012345678901';
...
DECLARE
  ...
  v_route_id UUID;
BEGIN
  SELECT id INTO v_route_id FROM public.routes WHERE slug = 'cyllage-city' AND game_id = 'e7f8a9b0-c1d2-3456-e789-012345678901';
  INSERT INTO public.trainers (route_id, name, trainer_class, is_boss, boss_type, level_cap, display_order, notes)
...
DECLARE
  ...
  v_route_id UUID;
BEGIN
  SELECT id INTO v_route_id FROM public.routes WHERE slug = 'shalour-city' AND game_id = 'e7f8a9b0-c1d2-3456-e789-012345678901';
  INSERT INTO public.trainers (route_id, name, trainer_class, is_boss, boss_type, level_cap, display_order, notes)
...
DECLARE
  ...
  v_route_id UUID;
BEGIN
  SELECT id INTO v_route_id FROM public.routes WHERE slug = 'coumarine-city' AND game_id = 'e7f8a9b0-c1d2-3456-e789-012345678901';
  INSERT INTO public.trainers (route_id, name, trainer_class, is_boss, boss_type, level_cap, display_order, notes)
...
DECLARE
  ...
  v_route_id UUID;
BEGIN
  SELECT id INTO v_route_id FROM public.routes WHERE slug = 'lumiose-city' AND game_id = 'e7f8a9b0-c1d2-3456-e789-012345678901';
  INSERT INTO public.trainers (route_id, name, trainer_class, is_boss, boss_type, level_cap, display_order, notes)
...
DECLARE
  ...
  v_route_id UUID;
BEGIN
  SELECT id INTO v_route_id FROM public.routes WHERE slug = 'laverre-city' AND game_id = 'e7f8a9b0-c1d2-3456-e789-012345678901';
  INSERT INTO public.trainers (route_id, name, trainer_class, is_boss, boss_type, level_cap, display_order, notes)
...
DECLARE
  ...
  v_route_id UUID;
BEGIN
  SELECT id INTO v_route_id FROM public.routes WHERE slug = 'anistar-city' AND game_id = 'e7f8a9b0-c1d2-3456-e789-012345678901';
  INSERT INTO public.trainers (route_id, name, trainer_class, is_boss, boss_type, level_cap, display_order, notes)
...
DECLARE
  ...
  v_route_id UUID;
BEGIN
  SELECT id INTO v_route_id FROM public.routes WHERE slug = 'snowbelle-city' AND game_id = 'e7f8a9b0-c1d2-3456-e789-012345678901';
  INSERT INTO public.trainers (route_id, name, trainer_class, is_boss, boss_type, level_cap, display_order, notes)
...
DECLARE
  ...
  v_route_id UUID;
BEGIN
  SELECT id INTO v_route_id FROM public.routes WHERE slug = 'pokemon-league' AND game_id = 'e7f8a9b0-c1d2-3456-e789-012345678901';
  INSERT INTO public.trainers (route_id, name, trainer_class, is_boss, boss_type, level_cap, display_order, notes)
...
UPDATE public.games SET total_routes = 53 WHERE id = 'e7f8a9b0-c1d2-3456-e789-012345678901';
