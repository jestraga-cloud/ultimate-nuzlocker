-- ===========================================
-- POKEMON WHITE 2: COMPLETE GAME DATA
-- Official Pokemon Game
-- Gen 5, Unova region
-- ===========================================
-- Game ID: c5d6e7f8-a9b0-1234-c567-890123456789
-- ===========================================
...
VALUES (
  'c5d6e7f8-a9b0-1234-c567-890123456789',
  'pokemon-white-2',
  'Pokemon White 2',
  5,
  'Unova',
  ...
  62,
  'Pokemon White 2 Version for Nintendo DS. A direct sequel set 2 years after Black/White. Features White Kyurem.'
);
...
('c5d6e7f8-a9b0-1234-c567-890123456789', 'Aspertia City', 'aspertia-city', 1, 'city', true, true, false, 'Starting city. Gym Leader Cheren. Normal-type.'),
('c5d6e7f8-a9b0-1234-c567-890123456789', 'Route 19', 'route-19', 2, 'route', true, true, false, NULL),
('c5d6e7f8-a9b0-1234-c567-890123456789', 'Floccesy Town', 'floccesy-town', 3, 'city', true, false, false, NULL),
('c5d6e7f8-a9b0-1234-c567-890123456789', 'Floccesy Ranch', 'floccesy-ranch', 4, 'route', true, true, false, NULL),
('c5d6e7f8-a9b0-1234-c567-890123456789', 'Route 20', 'route-20', 5, 'route', true, true, false, NULL),
('c5d6e7f8-a9b0-1234-c567-890123456789', 'Virbank City', 'virbank-city', 6, 'city', true, true, false, 'Gym Leader Roxie. Poison-type specialist.'),
('c5d6e7f8-a9b0-1234-c567-890123456789', 'Virbank Complex', 'virbank-complex', 7, 'building', true, true, false, NULL),
('c5d6e7f8-a9b0-1234-c567-890123456789', 'Castelia City', 'castelia-city', 8, 'city', false, true, true, 'Gym Leader Burgh. Bug-type specialist.'),
('c5d6e7f8-a9b0-1234-c567-890123456789', 'Castelia Sewers', 'castelia-sewers', 9, 'cave', true, true, false, NULL),
('c5d6e7f8-a9b0-1234-c567-890123456789', 'Route 4', 'route-4', 10, 'route', true, true, false, NULL),
('c5d6e7f8-a9b0-1234-c567-890123456789', 'Desert Resort', 'desert-resort', 11, 'route', true, true, false, NULL),
('c5d6e7f8-a9b0-1234-c567-890123456789', 'Relic Castle', 'relic-castle', 12, 'cave', true, false, true, NULL),
('c5d6e7f8-a9b0-1234-c567-890123456789', 'Nimbasa City', 'nimbasa-city', 13, 'city', false, true, false, 'Gym Leader Elesa. Electric-type specialist.'),
('c5d6e7f8-a9b0-1234-c567-890123456789', 'Route 5', 'route-5', 14, 'route', true, true, false, NULL),
('c5d6e7f8-a9b0-1234-c567-890123456789', 'Driftveil Drawbridge', 'driftveil-drawbridge', 15, 'route', true, false, false, 'Ducklett wing shadows.'),
('c5d6e7f8-a9b0-1234-c567-890123456789', 'Driftveil City', 'driftveil-city', 16, 'city', false, true, false, 'Gym Leader Clay. Ground-type specialist.'),
('c5d6e7f8-a9b0-1234-c567-890123456789', 'Relic Passage', 'relic-passage', 17, 'cave', true, false, true, NULL),
('c5d6e7f8-a9b0-1234-c567-890123456789', 'Route 6', 'route-6', 18, 'route', true, true, false, NULL),
('c5d6e7f8-a9b0-1234-c567-890123456789', 'Chargestone Cave', 'chargestone-cave', 19, 'cave', true, true, true, NULL),
('c5d6e7f8-a9b0-1234-c567-890123456789', 'Mistralton City', 'mistralton-city', 20, 'city', false, true, false, 'Gym Leader Skyla. Flying-type specialist.'),
('c5d6e7f8-a9b0-1234-c567-890123456789', 'Mistralton Cave', 'mistralton-cave', 21, 'cave', true, false, true, NULL),
('c5d6e7f8-a9b0-1234-c567-890123456789', 'Route 7', 'route-7', 22, 'route', true, true, false, NULL),
('c5d6e7f8-a9b0-1234-c567-890123456789', 'Celestial Tower', 'celestial-tower', 23, 'building', true, true, false, NULL),
('c5d6e7f8-a9b0-1234-c567-890123456789', 'Lentimas Town', 'lentimas-town', 24, 'city', false, false, false, NULL),
('c5d6e7f8-a9b0-1234-c567-890123456789', 'Reversal Mountain', 'reversal-mountain', 25, 'cave', true, true, true, NULL),
('c5d6e7f8-a9b0-1234-c567-890123456789', 'Strange House', 'strange-house', 26, 'building', true, false, true, NULL),
('c5d6e7f8-a9b0-1234-c567-890123456789', 'Undella Town', 'undella-town', 27, 'city', true, false, false, NULL),
('c5d6e7f8-a9b0-1234-c567-890123456789', 'Route 13', 'route-13', 28, 'route', true, true, false, NULL),
('c5d6e7f8-a9b0-1234-c567-890123456789', 'Lacunosa Town', 'lacunosa-town', 29, 'city', false, false, false, NULL),
('c5d6e7f8-a9b0-1234-c567-890123456789', 'Route 12', 'route-12', 30, 'route', true, true, false, NULL),
('c5d6e7f8-a9b0-1234-c567-890123456789', 'Village Bridge', 'village-bridge', 31, 'route', true, true, false, NULL),
('c5d6e7f8-a9b0-1234-c567-890123456789', 'Route 11', 'route-11', 32, 'route', true, true, false, NULL),
('c5d6e7f8-a9b0-1234-c567-890123456789', 'Opelucid City', 'opelucid-city', 33, 'city', false, true, false, 'Gym Leader Drayden. Dragon-type specialist.'),
('c5d6e7f8-a9b0-1234-c567-890123456789', 'Route 9', 'route-9', 34, 'route', true, true, false, NULL),
('c5d6e7f8-a9b0-1234-c567-890123456789', 'Humilau City', 'humilau-city', 35, 'city', true, true, false, 'Gym Leader Marlon. Water-type specialist.'),
('c5d6e7f8-a9b0-1234-c567-890123456789', 'Route 22', 'route-22', 36, 'route', true, true, false, NULL),
('c5d6e7f8-a9b0-1234-c567-890123456789', 'Route 21', 'route-21', 37, 'water', true, true, false, NULL),
('c5d6e7f8-a9b0-1234-c567-890123456789', 'Seaside Cave', 'seaside-cave', 38, 'cave', true, true, true, NULL),
('c5d6e7f8-a9b0-1234-c567-890123456789', 'Route 23', 'route-23', 39, 'route', true, true, false, NULL),
('c5d6e7f8-a9b0-1234-c567-890123456789', 'Giant Chasm', 'giant-chasm', 40, 'cave', true, true, true, 'Kyurem encounter.'),
('c5d6e7f8-a9b0-1234-c567-890123456789', 'Victory Road', 'victory-road', 41, 'cave', true, true, true, NULL),
('c5d6e7f8-a9b0-1234-c567-890123456789', 'Pokemon League', 'pokemon-league', 42, 'building', false, true, false, 'Elite Four and Champion Iris.'),
('c5d6e7f8-a9b0-1234-c567-890123456789', 'Route 1', 'route-1', 43, 'route', true, false, false, NULL),
('c5d6e7f8-a9b0-1234-c567-890123456789', 'Route 2', 'route-2', 44, 'route', true, true, false, NULL),
('c5d6e7f8-a9b0-1234-c567-890123456789', 'Route 3', 'route-3', 45, 'route', true, true, false, NULL),
('c5d6e7f8-a9b0-1234-c567-890123456789', 'Dreamyard', 'dreamyard', 46, 'route', true, false, false, NULL),
('c5d6e7f8-a9b0-1234-c567-890123456789', 'Pinwheel Forest', 'pinwheel-forest', 47, 'route', true, false, false, NULL),
('c5d6e7f8-a9b0-1234-c567-890123456789', 'Twist Mountain', 'twist-mountain', 48, 'cave', true, false, true, NULL),
('c5d6e7f8-a9b0-1234-c567-890123456789', 'Dragonspiral Tower', 'dragonspiral-tower', 49, 'building', true, false, false, NULL),
('c5d6e7f8-a9b0-1234-c567-890123456789', 'Moor of Icirrus', 'moor-of-icirrus', 50, 'route', true, false, false, NULL),
('c5d6e7f8-a9b0-1234-c567-890123456789', 'Route 8', 'route-8', 51, 'route', true, true, false, NULL),
('c5d6e7f8-a9b0-1234-c567-890123456789', 'Undella Bay', 'undella-bay', 52, 'water', true, true, false, NULL),
('c5d6e7f8-a9b0-1234-c567-890123456789', 'Route 14', 'route-14', 53, 'route', true, true, false, NULL),
('c5d6e7f8-a9b0-1234-c567-890123456789', 'Abundant Shrine', 'abundant-shrine', 54, 'special', true, false, false, NULL),
('c5d6e7f8-a9b0-1234-c567-890123456789', 'Route 15', 'route-15', 55, 'route', true, true, false, NULL),
('c5d6e7f8-a9b0-1234-c567-890123456789', 'Route 16', 'route-16', 56, 'route', true, true, false, NULL),
('c5d6e7f8-a9b0-1234-c567-890123456789', 'Lostlorn Forest', 'lostlorn-forest', 57, 'route', true, false, false, NULL),
('c5d6e7f8-a9b0-1234-c567-890123456789', 'Route 17', 'route-17', 58, 'water', true, true, false, NULL),
('c5d6e7f8-a9b0-1234-c567-890123456789', 'Route 18', 'route-18', 59, 'route', true, true, false, NULL),
('c5d6e7f8-a9b0-1234-c567-890123456789', 'P2 Laboratory', 'p2-laboratory', 60, 'building', true, false, true, NULL),
('c5d6e7f8-a9b0-1234-c567-890123456789', 'Clay Tunnel', 'clay-tunnel', 61, 'cave', true, false, true, NULL),
('c5d6e7f8-a9b0-1234-c567-890123456789', 'Nature Sanctuary', 'nature-sanctuary', 62, 'special', true, false, false, NULL);
...
FROM public.routes r WHERE r.slug = 'aspertia-city' AND r.game_id = 'c5d6e7f8-a9b0-1234-c567-890123456789';
...
-- ===========================================
-- STEP 4: ENCOUNTER DATA (823 total)
-- ===========================================
...
('floccesy-town', 147, 'gift', 100.00, 1, 1, NULL, NULL),
...
('floccesy-ranch', 550, 'surfing', 130.00, 5, 15, NULL, NULL),
('floccesy-ranch', 10016, 'fishing_super', 80.00, 40, 60, NULL, NULL),
('floccesy-ranch', 10016, 'surfing', 140.00, 5, 15, NULL, NULL),
...
('route-20', 550, 'surfing', 65.00, 5, 15, NULL, NULL),
('route-20', 10016, 'fishing_super', 40.00, 40, 60, NULL, NULL),
('route-20', 10016, 'surfing', 70.00, 5, 15, NULL, NULL),
...
('virbank-complex', 239, 'walking', 65.00, 10, 13, NULL, NULL),
...
('route-4', 368, 'fishing_super', 5.00, 50, 70, NULL, NULL),
...
('route-5', 568, 'walking', 40.00, 21, 26, NULL, NULL),
('route-5', 572, 'walking', 60.00, 21, 25, NULL, NULL),
('route-5', 573, 'walking', 5.00, 24, 24, NULL, NULL),
('route-5', 577, 'walking', 60.00, 21, 26, NULL, NULL),
...
('relic-passage', 550, 'surfing', 35.00, 10, 30, NULL, NULL),
('relic-passage', 10016, 'fishing_super', 40.00, 40, 60, NULL, NULL),
('relic-passage', 10016, 'surfing', 70.00, 10, 30, NULL, NULL),
...
('route-6', 183, 'surfing', 90.00, 10, 35, NULL, NULL),
('route-6', 184, 'walking', 5.00, 26, 26, NULL, NULL),
('route-6', 184, 'surfing', 5.00, 10, 35, NULL, NULL),
...
('strange-house', 577, 'walking', 40.00, 31, 31, NULL, NULL),
('strange-house', 578, 'walking', 20.00, 33, 34, NULL, NULL),
...
('route-12', 127, 'walking', 30.00, 36, 42, NULL, NULL),
...
('village-bridge', 550, 'surfing', 30.00, 25, 40, NULL, NULL),
('village-bridge', 587, 'walking', 10.00, 37, 37, NULL, NULL),
('village-bridge', 10016, 'fishing_super', 40.00, 40, 60, NULL, NULL),
('village-bridge', 10016, 'surfing', 70.00, 25, 40, NULL, NULL),
('route-11', 55, 'walking', 40.00, 36, 40, NULL, NULL),
('route-11', 118, 'fishing_super', 100.00, 40, 70, NULL, NULL),
...
('route-11', 550, 'fishing_super', 40.00, 40, 60, NULL, NULL),
('route-11', 550, 'surfing', 30.00, 25, 40, NULL, NULL),
('route-11', 587, 'walking', 10.00, 37, 37, NULL, NULL),
('route-11', 588, 'walking', 50.00, 36, 43, NULL, NULL),
('route-11', 591, 'walking', 10.00, 37, 41, NULL, NULL),
('route-11', 591, 'static', 200.00, 47, 47, NULL, NULL),
('route-11', 616, 'walking', 10.00, 36, 40, NULL, NULL),
...
('route-11', 10016, 'surfing', 70.00, 25, 40, NULL, NULL),
...
('route-9', 578, 'walking', 50.00, 37, 43, NULL, NULL),
('route-9', 579, 'walking', 5.00, 40, 40, NULL, NULL),
...
('route-22', 550, 'surfing', 35.00, 15, 45, NULL, NULL),
...
('route-22', 10016, 'surfing', 70.00, 15, 40, NULL, NULL),
...
('route-23', 538, 'walking', 50.00, 48, 54, NULL, NULL),
('route-23', 539, 'walking', 5.00, 51, 51, NULL, NULL),
('route-23', 550, 'fishing_super', 40.00, 40, 60, NULL, NULL),
('route-23', 550, 'surfing', 30.00, 40, 55, NULL, NULL),
...
('route-23', 627, 'walking', 10.00, 47, 52, NULL, NULL),
('route-23', 10016, 'fishing_super', 40.00, 40, 60, NULL, NULL),
('route-23', 10016, 'surfing', 70.00, 40, 55, NULL, NULL),
...
('giant-chasm', 550, 'surfing', 30.00, 35, 50, NULL, NULL),
('giant-chasm', 10016, 'fishing_super', 40.00, 40, 60, NULL, NULL),
('giant-chasm', 10016, 'surfing', 70.00, 35, 50, NULL, NULL),
...
('victory-road', 548, 'walking', 140.00, 47, 55, NULL, NULL),
('victory-road', 549, 'walking', 5.00, 50, 50, NULL, NULL),
...
('route-1', 550, 'fishing_super', 40.00, 40, 60, NULL, NULL),
('route-1', 550, 'surfing', 100.00, 45, 60, NULL, NULL),
('route-1', 560, 'walking', 11.00, 66, 67, NULL, NULL),
('route-1', 10016, 'fishing_super', 95.00, 40, 70, NULL, NULL),
...
('route-3', 550, 'surfing', 30.00, 45, 60, NULL, NULL),
('route-3', 10016, 'fishing_super', 40.00, 40, 60, NULL, NULL),
('route-3', 10016, 'surfing', 70.00, 45, 60, NULL, NULL),
...
('dreamyard', 380, 'static', 100.00, 68, 68, NULL, NULL),
...
('pinwheel-forest', 531, 'walking', 140.00, 54, 57, NULL, NULL),
...
('pinwheel-forest', 538, 'walking', 30.00, 55, 65, NULL, NULL),
('pinwheel-forest', 539, 'walking', 5.00, 57, 57, NULL, NULL),
...
('pinwheel-forest', 548, 'walking', 90.00, 54, 65, NULL, NULL),
('pinwheel-forest', 549, 'walking', 5.00, 57, 57, NULL, NULL),
('pinwheel-forest', 550, 'fishing_super', 40.00, 35, 60, NULL, NULL),
('pinwheel-forest', 550, 'surfing', 35.00, 45, 60, NULL, NULL),
('pinwheel-forest', 10016, 'fishing_super', 40.00, 40, 60, NULL, NULL),
('pinwheel-forest', 10016, 'surfing', 70.00, 45, 60, NULL, NULL),
...
('moor-of-icirrus', 588, 'walking', 20.00, 54, 54, 'Spring', NULL),
('moor-of-icirrus', 588, 'walking', 20.00, 54, 54, 'Summer', NULL),
('moor-of-icirrus', 588, 'walking', 20.00, 54, 54, 'Autumn', NULL),
('moor-of-icirrus', 616, 'walking', 5.00, 57, 57, 'Spring', NULL),
('moor-of-icirrus', 616, 'walking', 5.00, 57, 57, 'Summer', NULL),
('moor-of-icirrus', 616, 'walking', 5.00, 57, 57, 'Autumn', NULL),
...
('route-8', 588, 'walking', 20.00, 54, 54, 'Spring', NULL),
('route-8', 588, 'walking', 20.00, 54, 54, 'Summer', NULL),
('route-8', 588, 'walking', 20.00, 54, 54, 'Autumn', NULL),
('route-8', 616, 'walking', 5.00, 57, 57, 'Spring', NULL),
('route-8', 616, 'walking', 5.00, 57, 57, 'Summer', NULL),
('route-8', 616, 'walking', 5.00, 57, 57, 'Autumn', NULL),
...
('route-14', 418, 'surfing', 90.00, 25, 40, NULL, NULL),
('route-14', 419, 'surfing', 10.00, 30, 40, NULL, NULL),
...
('route-14', 550, 'surfing', 30.00, 25, 40, NULL, NULL),
...
('route-14', 10016, 'surfing', 70.00, 25, 40, NULL, NULL),
...
('abundant-shrine', 184, 'walking', 5.00, 36, 36, NULL, NULL),
...
('abundant-shrine', 531, 'walking', 75.00, 33, 36, NULL, NULL),
('abundant-shrine', 548, 'walking', 65.00, 33, 39, NULL, NULL),
('abundant-shrine', 549, 'walking', 5.00, 36, 36, NULL, NULL),
('abundant-shrine', 550, 'fishing_super', 40.00, 40, 60, NULL, NULL),
('abundant-shrine', 550, 'surfing', 35.00, 25, 40, NULL, NULL),
('abundant-shrine', 587, 'walking', 10.00, 34, 34, NULL, NULL),
('abundant-shrine', 10016, 'fishing_super', 40.00, 40, 60, NULL, NULL),
('abundant-shrine', 10016, 'surfing', 70.00, 25, 40, NULL, NULL),
...
('route-15', 538, 'walking', 40.00, 55, 65, NULL, NULL),
('route-15', 539, 'walking', 5.00, 57, 57, NULL, NULL),
...
('route-16', 568, 'walking', 40.00, 21, 26, NULL, NULL),
('route-16', 572, 'walking', 60.00, 21, 25, NULL, NULL),
('route-16', 573, 'walking', 5.00, 24, 24, NULL, NULL),
('route-16', 577, 'walking', 60.00, 21, 26, NULL, NULL),
...
('lostlorn-forest', 127, 'walking', 10.00, 24, 26, NULL, NULL),
...
('lostlorn-forest', 548, 'walking', 50.00, 21, 26, NULL, NULL),
('lostlorn-forest', 549, 'walking', 5.00, 24, 24, NULL, NULL),
('lostlorn-forest', 550, 'fishing_super', 40.00, 40, 60, NULL, NULL),
('lostlorn-forest', 550, 'surfing', 30.00, 10, 30, NULL, NULL),
('lostlorn-forest', 587, 'walking', 10.00, 22, 22, NULL, NULL),
('lostlorn-forest', 10016, 'fishing_super', 40.00, 40, 60, NULL, NULL),
('lostlorn-forest', 10016, 'surfing', 70.00, 10, 25, NULL, NULL),
...
('route-18', 538, 'walking', 40.00, 57, 67, NULL, NULL),
('route-18', 539, 'walking', 5.00, 59, 59, NULL, NULL),
...
('nature-sanctuary', 550, 'surfing', 35.00, 45, 60, NULL, NULL),
...
('nature-sanctuary', 10016, 'surfing', 70.00, 45, 60, NULL, NULL);
...
FROM _enc e JOIN public.routes r ON r.slug = e.slug AND r.game_id = 'c5d6e7f8-a9b0-1234-c567-890123456789';
...
DECLARE
  ...
  v_route_id UUID;
BEGIN
  SELECT id INTO v_route_id FROM public.routes WHERE slug = 'aspertia-city' AND game_id = 'c5d6e7f8-a9b0-1234-c567-890123456789';
...
DECLARE
  ...
  v_route_id UUID;
BEGIN
  SELECT id INTO v_route_id FROM public.routes WHERE slug = 'virbank-city' AND game_id = 'c5d6e7f8-a9b0-1234-c567-890123456789';
  INSERT INTO public.trainers (route_id, name, trainer_class, is_boss, boss_type, level_cap, display_order, notes)
...
DECLARE
  ...
  v_route_id UUID;
BEGIN
  SELECT id INTO v_route_id FROM public.routes WHERE slug = 'castelia-city' AND game_id = 'c5d6e7f8-a9b0-1234-c567-890123456789';
  INSERT INTO public.trainers (route_id, name, trainer_class, is_boss, boss_type, level_cap, display_order, notes)
...
DECLARE
  ...
  v_route_id UUID;
BEGIN
  SELECT id INTO v_route_id FROM public.routes WHERE slug = 'nimbasa-city' AND game_id = 'c5d6e7f8-a9b0-1234-c567-890123456789';
  INSERT INTO public.trainers (route_id, name, trainer_class, is_boss, boss_type, level_cap, display_order, notes)
...
DECLARE
  ...
  v_route_id UUID;
BEGIN
  SELECT id INTO v_route_id FROM public.routes WHERE slug = 'driftveil-city' AND game_id = 'c5d6e7f8-a9b0-1234-c567-890123456789';
  INSERT INTO public.trainers (route_id, name, trainer_class, is_boss, boss_type, level_cap, display_order, notes)
...
DECLARE
  ...
  v_route_id UUID;
BEGIN
  SELECT id INTO v_route_id FROM public.routes WHERE slug = 'mistralton-city' AND game_id = 'c5d6e7f8-a9b0-1234-c567-890123456789';
  INSERT INTO public.trainers (route_id, name, trainer_class, is_boss, boss_type, level_cap, display_order, notes)
...
DECLARE
  ...
  v_route_id UUID;
BEGIN
  SELECT id INTO v_route_id FROM public.routes WHERE slug = 'opelucid-city' AND game_id = 'c5d6e7f8-a9b0-1234-c567-890123456789';
  INSERT INTO public.trainers (route_id, name, trainer_class, is_boss, boss_type, level_cap, display_order, notes)
...
DECLARE
  ...
  v_route_id UUID;
BEGIN
  SELECT id INTO v_route_id FROM public.routes WHERE slug = 'humilau-city' AND game_id = 'c5d6e7f8-a9b0-1234-c567-890123456789';
  INSERT INTO public.trainers (route_id, name, trainer_class, is_boss, boss_type, level_cap, display_order, notes)
...
DECLARE
  ...
  v_route_id UUID;
BEGIN
  SELECT id INTO v_route_id FROM public.routes WHERE slug = 'pokemon-league' AND game_id = 'c5d6e7f8-a9b0-1234-c567-890123456789';
  INSERT INTO public.trainers (route_id, name, trainer_class, is_boss, boss_type, level_cap, display_order, notes)
...
UPDATE public.games SET total_routes = 62 WHERE id = 'c5d6e7f8-a9b0-1234-c567-890123456789';
