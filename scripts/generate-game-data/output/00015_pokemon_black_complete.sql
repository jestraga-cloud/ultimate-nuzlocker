-- ===========================================
-- POKEMON BLACK: COMPLETE GAME DATA
-- Official Pokemon Game
-- Gen 5, Unova region
-- ===========================================
-- Game ID: f2a3b4c5-d6e7-8901-f234-567890123456
-- ===========================================
...
VALUES (
  'f2a3b4c5-d6e7-8901-f234-567890123456',
  'pokemon-black',
  'Pokemon Black',
  5,
  'Unova',
  ...
  52,
  'Pokemon Black Version for Nintendo DS. Set in the Unova region with an all-new Pokedex. Features Zekrom and Team Plasma.'
);
...
('f2a3b4c5-d6e7-8901-f234-567890123456', 'Nuvema Town', 'nuvema-town', 1, 'city', true, false, false, 'Starter town. Choose Snivy, Tepig, or Oshawott.'),
('f2a3b4c5-d6e7-8901-f234-567890123456', 'Route 1', 'route-1', 2, 'route', true, false, false, NULL),
('f2a3b4c5-d6e7-8901-f234-567890123456', 'Accumula Town', 'accumula-town', 3, 'city', false, false, false, 'Team Plasma introduction.'),
('f2a3b4c5-d6e7-8901-f234-567890123456', 'Route 2', 'route-2', 4, 'route', true, true, false, NULL),
('f2a3b4c5-d6e7-8901-f234-567890123456', 'Striaton City', 'striaton-city', 5, 'city', false, true, false, 'Gym 1: Cilan/Chili/Cress. Starter-dependent.'),
('f2a3b4c5-d6e7-8901-f234-567890123456', 'Dreamyard', 'dreamyard', 6, 'route', true, true, false, 'Elemental monkey gift.'),
('f2a3b4c5-d6e7-8901-f234-567890123456', 'Route 3', 'route-3', 7, 'route', true, true, false, NULL),
('f2a3b4c5-d6e7-8901-f234-567890123456', 'Wellspring Cave', 'wellspring-cave', 8, 'cave', true, false, false, NULL),
('f2a3b4c5-d6e7-8901-f234-567890123456', 'Nacrene City', 'nacrene-city', 9, 'city', false, true, false, 'Gym Leader Lenora. Normal-type specialist.'),
('f2a3b4c5-d6e7-8901-f234-567890123456', 'Pinwheel Forest', 'pinwheel-forest', 10, 'route', true, true, false, NULL),
('f2a3b4c5-d6e7-8901-f234-567890123456', 'Castelia City', 'castelia-city', 11, 'city', false, true, true, 'Gym Leader Burgh. Bug-type specialist.'),
('f2a3b4c5-d6e7-8901-f234-567890123456', 'Route 4', 'route-4', 12, 'route', true, true, false, NULL),
('f2a3b4c5-d6e7-8901-f234-567890123456', 'Desert Resort', 'desert-resort', 13, 'route', true, true, false, NULL),
('f2a3b4c5-d6e7-8901-f234-567890123456', 'Relic Castle', 'relic-castle', 14, 'cave', true, false, true, NULL),
('f2a3b4c5-d6e7-8901-f234-567890123456', 'Nimbasa City', 'nimbasa-city', 15, 'city', false, true, false, 'Gym Leader Elesa. Electric-type specialist.'),
('f2a3b4c5-d6e7-8901-f234-567890123456', 'Route 5', 'route-5', 16, 'route', true, true, false, NULL),
('f2a3b4c5-d6e7-8901-f234-567890123456', 'Driftveil Drawbridge', 'driftveil-drawbridge', 17, 'route', true, false, false, 'Ducklett wing shadows.'),
('f2a3b4c5-d6e7-8901-f234-567890123456', 'Driftveil City', 'driftveil-city', 18, 'city', false, true, false, 'Gym Leader Clay. Ground-type specialist.'),
('f2a3b4c5-d6e7-8901-f234-567890123456', 'Cold Storage', 'cold-storage', 19, 'building', true, true, false, NULL),
('f2a3b4c5-d6e7-8901-f234-567890123456', 'Route 6', 'route-6', 20, 'route', true, true, false, NULL),
('f2a3b4c5-d6e7-8901-f234-567890123456', 'Chargestone Cave', 'chargestone-cave', 21, 'cave', true, true, true, NULL),
('f2a3b4c5-d6e7-8901-f234-567890123456', 'Mistralton City', 'mistralton-city', 22, 'city', false, true, false, 'Gym Leader Skyla. Flying-type specialist.'),
('f2a3b4c5-d6e7-8901-f234-567890123456', 'Route 7', 'route-7', 23, 'route', true, true, false, NULL),
('f2a3b4c5-d6e7-8901-f234-567890123456', 'Celestial Tower', 'celestial-tower', 24, 'building', true, true, false, NULL),
('f2a3b4c5-d6e7-8901-f234-567890123456', 'Twist Mountain', 'twist-mountain', 25, 'cave', true, true, true, NULL),
('f2a3b4c5-d6e7-8901-f234-567890123456', 'Icirrus City', 'icirrus-city', 26, 'city', true, true, false, 'Gym Leader Brycen. Ice-type specialist.'),
('f2a3b4c5-d6e7-8901-f234-567890123456', 'Dragonspiral Tower', 'dragonspiral-tower', 27, 'building', true, false, false, 'Legendary dragon encounter.'),
('f2a3b4c5-d6e7-8901-f234-567890123456', 'Route 8', 'route-8', 28, 'route', true, true, false, NULL),
('f2a3b4c5-d6e7-8901-f234-567890123456', 'Moor of Icirrus', 'moor-of-icirrus', 29, 'route', true, false, false, NULL),
('f2a3b4c5-d6e7-8901-f234-567890123456', 'Route 9', 'route-9', 30, 'route', true, true, false, NULL),
('f2a3b4c5-d6e7-8901-f234-567890123456', 'Opelucid City', 'opelucid-city', 31, 'city', false, true, false, 'Gym 8: Drayden (Black) / Iris (White). Dragon-type.'),
('f2a3b4c5-d6e7-8901-f234-567890123456', 'Route 10', 'route-10', 32, 'route', true, true, false, NULL),
('f2a3b4c5-d6e7-8901-f234-567890123456', 'Victory Road', 'victory-road', 33, 'cave', true, true, true, NULL),
('f2a3b4c5-d6e7-8901-f234-567890123456', 'Pokemon League', 'pokemon-league', 34, 'building', false, true, false, 'Elite Four and Champion N/Ghetsis.'),
('f2a3b4c5-d6e7-8901-f234-567890123456', 'Route 11', 'route-11', 35, 'route', true, true, false, NULL),
('f2a3b4c5-d6e7-8901-f234-567890123456', 'Village Bridge', 'village-bridge', 36, 'route', true, true, false, NULL),
('f2a3b4c5-d6e7-8901-f234-567890123456', 'Route 12', 'route-12', 37, 'route', true, true, false, NULL),
('f2a3b4c5-d6e7-8901-f234-567890123456', 'Lacunosa Town', 'lacunosa-town', 38, 'city', false, false, false, NULL),
('f2a3b4c5-d6e7-8901-f234-567890123456', 'Route 13', 'route-13', 39, 'route', true, true, false, NULL),
('f2a3b4c5-d6e7-8901-f234-567890123456', 'Undella Town', 'undella-town', 40, 'city', true, false, false, NULL),
('f2a3b4c5-d6e7-8901-f234-567890123456', 'Undella Bay', 'undella-bay', 41, 'water', true, true, false, NULL),
('f2a3b4c5-d6e7-8901-f234-567890123456', 'Route 14', 'route-14', 42, 'route', true, true, false, NULL),
('f2a3b4c5-d6e7-8901-f234-567890123456', 'Abundant Shrine', 'abundant-shrine', 43, 'special', true, false, false, NULL),
('f2a3b4c5-d6e7-8901-f234-567890123456', 'Route 15', 'route-15', 44, 'route', true, true, false, NULL),
('f2a3b4c5-d6e7-8901-f234-567890123456', 'Route 16', 'route-16', 45, 'route', true, true, false, NULL),
('f2a3b4c5-d6e7-8901-f234-567890123456', 'Lostlorn Forest', 'lostlorn-forest', 46, 'route', true, false, false, NULL),
('f2a3b4c5-d6e7-8901-f234-567890123456', 'Route 17', 'route-17', 47, 'water', true, true, false, NULL),
('f2a3b4c5-d6e7-8901-f234-567890123456', 'Route 18', 'route-18', 48, 'route', true, true, false, NULL),
('f2a3b4c5-d6e7-8901-f234-567890123456', 'P2 Laboratory', 'p2-laboratory', 49, 'building', true, false, true, NULL),
('f2a3b4c5-d6e7-8901-f234-567890123456', 'Challenger''s Cave', 'challengers-cave', 50, 'cave', true, true, true, NULL),
('f2a3b4c5-d6e7-8901-f234-567890123456', 'Giant Chasm', 'giant-chasm', 51, 'cave', true, false, true, 'Kyurem encounter.'),
('f2a3b4c5-d6e7-8901-f234-567890123456', 'Mistralton Cave', 'mistralton-cave', 52, 'cave', true, false, true, NULL);
...
FROM public.routes r WHERE r.slug = 'nuvema-town' AND r.game_id = 'f2a3b4c5-d6e7-8901-f234-567890123456';
...
('route-1', 550, 'fishing_super', 95.00, 35, 55, NULL, NULL),
('route-1', 550, 'surfing', 100.00, 5, 15, NULL, NULL),
('route-1', 559, 'walking', 25.00, 32, 35, NULL, NULL),
('route-1', 10016, 'fishing_super', 55.00, 35, 70, NULL, NULL),
('route-1', 10016, 'surfing', 100.00, 5, 20, NULL, NULL),
...
('route-3', 550, 'fishing_super', 40.00, 35, 55, NULL, NULL),
('route-3', 550, 'surfing', 100.00, 5, 15, NULL, NULL),
('route-3', 10016, 'fishing_super', 40.00, 35, 60, NULL, NULL),
('route-3', 10016, 'surfing', 100.00, 5, 20, NULL, NULL),
...
('wellspring-cave', 550, 'fishing_super', 40.00, 35, 55, NULL, NULL),
('wellspring-cave', 550, 'surfing', 100.00, 5, 15, NULL, NULL),
('wellspring-cave', 10016, 'fishing_super', 40.00, 35, 60, NULL, NULL),
('wellspring-cave', 10016, 'surfing', 100.00, 5, 20, NULL, NULL),
...
('pinwheel-forest', 538, 'walking', 5.00, 15, 15, NULL, NULL),
('pinwheel-forest', 539, 'walking', 20.00, 12, 17, NULL, NULL),
...
('pinwheel-forest', 546, 'walking', 70.00, 14, 25, NULL, NULL),
('pinwheel-forest', 547, 'walking', 5.00, 17, 17, NULL, NULL),
('pinwheel-forest', 550, 'fishing_super', 40.00, 35, 55, NULL, NULL),
...
('route-4', 367, 'fishing_super', 5.00, 45, 70, NULL, NULL),
...
('route-5', 574, 'walking', 60.00, 19, 25, NULL, NULL),
...
('route-6', 550, 'fishing_super', 40.00, 35, 55, NULL, NULL),
('route-6', 550, 'surfing', 100.00, 10, 25, NULL, NULL),
...
('route-6', 10016, 'fishing_super', 40.00, 35, 60, NULL, NULL),
('route-6', 10016, 'surfing', 100.00, 10, 30, NULL, NULL),
...
('dragonspiral-tower', 550, 'fishing_super', 40.00, 35, 55, NULL, NULL),
('dragonspiral-tower', 550, 'surfing', 100.00, 15, 35, NULL, NULL),
('dragonspiral-tower', 586, 'walking', 30.00, 34, 36, NULL, NULL),
('dragonspiral-tower', 10016, 'fishing_super', 40.00, 35, 60, NULL, NULL),
('dragonspiral-tower', 10016, 'surfing', 100.00, 15, 40, NULL, NULL),
...
('route-9', 575, 'walking', 60.00, 31, 39, NULL, NULL),
('route-9', 576, 'walking', 5.00, 34, 34, NULL, NULL),
...
('route-10', 538, 'walking', 5.00, 36, 36, NULL, NULL),
('route-10', 539, 'walking', 20.00, 33, 41, NULL, NULL),
...
('victory-road', 550, 'fishing_super', 40.00, 35, 55, NULL, NULL),
('victory-road', 550, 'surfing', 100.00, 20, 45, NULL, NULL),
('victory-road', 632, 'walking', 160.00, 37, 42, NULL, NULL),
('victory-road', 633, 'walking', 20.00, 38, 40, NULL, NULL),
('victory-road', 10016, 'fishing_super', 40.00, 35, 60, NULL, NULL),
('victory-road', 10016, 'surfing', 100.00, 20, 50, NULL, NULL),
...
('route-11', 550, 'fishing_super', 40.00, 35, 55, NULL, NULL),
('route-11', 550, 'surfing', 70.00, 25, 55, NULL, NULL),
...
('route-11', 629, 'walking', 25.00, 48, 50, NULL, NULL),
('route-11', 630, 'walking', 25.00, 58, 60, NULL, NULL),
('route-11', 10016, 'fishing_super', 40.00, 35, 60, NULL, NULL),
('route-11', 10016, 'surfing', 30.00, 25, 60, NULL, NULL),
...
('village-bridge', 550, 'fishing_super', 40.00, 35, 55, NULL, NULL),
('village-bridge', 550, 'surfing', 100.00, 25, 55, NULL, NULL),
('village-bridge', 587, 'walking', 10.00, 48, 48, NULL, NULL),
('village-bridge', 629, 'walking', 20.00, 48, 50, NULL, NULL),
('village-bridge', 630, 'walking', 20.00, 58, 60, NULL, NULL),
('village-bridge', 10016, 'fishing_super', 40.00, 35, 60, NULL, NULL),
('village-bridge', 10016, 'surfing', 95.00, 25, 70, NULL, NULL),
('route-12', 14, 'walking', 20.00, 48, 59, NULL, NULL),
('route-12', 15, 'walking', 5.00, 50, 50, NULL, NULL),
...
('route-14', 550, 'fishing_super', 40.00, 35, 55, NULL, NULL),
('route-14', 550, 'surfing', 70.00, 25, 55, NULL, NULL),
...
('route-14', 10016, 'fishing_super', 40.00, 35, 60, NULL, NULL),
('route-14', 10016, 'surfing', 30.00, 25, 60, NULL, NULL),
...
('abundant-shrine', 198, 'walking', 10.00, 48, 58, NULL, NULL),
...
('abundant-shrine', 430, 'walking', 5.00, 50, 50, NULL, NULL),
('abundant-shrine', 437, 'walking', 20.00, 48, 60, NULL, NULL),
('abundant-shrine', 531, 'walking', 75.00, 47, 50, NULL, NULL),
('abundant-shrine', 546, 'walking', 20.00, 48, 58, NULL, NULL),
('abundant-shrine', 547, 'walking', 5.00, 50, 50, NULL, NULL),
('abundant-shrine', 550, 'fishing_super', 40.00, 35, 55, NULL, NULL),
('abundant-shrine', 550, 'surfing', 70.00, 25, 55, NULL, NULL),
('abundant-shrine', 587, 'walking', 10.00, 48, 48, NULL, NULL),
('abundant-shrine', 645, 'static', 100.00, 70, 70, 'special-encounter-couldnt-capture-before', NULL),
('abundant-shrine', 10016, 'fishing_super', 40.00, 35, 60, NULL, NULL),
('abundant-shrine', 10016, 'surfing', 30.00, 25, 60, NULL, NULL),
...
('route-15', 538, 'walking', 5.00, 50, 50, NULL, NULL),
('route-15', 539, 'walking', 30.00, 48, 59, NULL, NULL),
...
('route-16', 574, 'walking', 60.00, 19, 25, NULL, NULL),
...
('lostlorn-forest', 546, 'walking', 70.00, 19, 25, NULL, NULL),
('lostlorn-forest', 547, 'walking', 5.00, 22, 22, NULL, NULL),
('lostlorn-forest', 550, 'fishing_super', 40.00, 35, 55, NULL, NULL),
...
('lostlorn-forest', 10016, 'fishing_super', 40.00, 35, 60, NULL, NULL),
...
('route-18', 538, 'walking', 5.00, 31, 31, NULL, NULL),
('route-18', 539, 'walking', 20.00, 29, 35, NULL, NULL),
...
('challengers-cave', 550, 'fishing_super', 40.00, 35, 55, NULL, NULL),
('challengers-cave', 550, 'surfing', 100.00, 25, 55, NULL, NULL),
('challengers-cave', 10016, 'fishing_super', 40.00, 35, 60, NULL, NULL),
('challengers-cave', 10016, 'surfing', 100.00, 25, 70, NULL, NULL),
...
('giant-chasm', 550, 'fishing_super', 80.00, 35, 55, NULL, NULL),
('giant-chasm', 550, 'surfing', 140.00, 25, 55, NULL, NULL),
('giant-chasm', 10016, 'fishing_super', 80.00, 35, 60, NULL, NULL),
('giant-chasm', 10016, 'surfing', 60.00, 25, 60, NULL, NULL),
...
FROM _enc e JOIN public.routes r ON r.slug = e.slug AND r.game_id = 'f2a3b4c5-d6e7-8901-f234-567890123456';
...
DECLARE
  ...
  v_route_id UUID;
BEGIN
  SELECT id INTO v_route_id FROM public.routes WHERE slug = 'striaton-city' AND game_id = 'f2a3b4c5-d6e7-8901-f234-567890123456';
...
DECLARE
  ...
  v_route_id UUID;
BEGIN
  SELECT id INTO v_route_id FROM public.routes WHERE slug = 'nacrene-city' AND game_id = 'f2a3b4c5-d6e7-8901-f234-567890123456';
  INSERT INTO public.trainers (route_id, name, trainer_class, is_boss, boss_type, level_cap, display_order, notes)
...
DECLARE
  ...
  v_route_id UUID;
BEGIN
  SELECT id INTO v_route_id FROM public.routes WHERE slug = 'castelia-city' AND game_id = 'f2a3b4c5-d6e7-8901-f234-567890123456';
  INSERT INTO public.trainers (route_id, name, trainer_class, is_boss, boss_type, level_cap, display_order, notes)
...
DECLARE
  ...
  v_route_id UUID;
BEGIN
  SELECT id INTO v_route_id FROM public.routes WHERE slug = 'nimbasa-city' AND game_id = 'f2a3b4c5-d6e7-8901-f234-567890123456';
  INSERT INTO public.trainers (route_id, name, trainer_class, is_boss, boss_type, level_cap, display_order, notes)
...
DECLARE
  ...
  v_route_id UUID;
BEGIN
  SELECT id INTO v_route_id FROM public.routes WHERE slug = 'driftveil-city' AND game_id = 'f2a3b4c5-d6e7-8901-f234-567890123456';
  INSERT INTO public.trainers (route_id, name, trainer_class, is_boss, boss_type, level_cap, display_order, notes)
...
DECLARE
  ...
  v_route_id UUID;
BEGIN
  SELECT id INTO v_route_id FROM public.routes WHERE slug = 'mistralton-city' AND game_id = 'f2a3b4c5-d6e7-8901-f234-567890123456';
  INSERT INTO public.trainers (route_id, name, trainer_class, is_boss, boss_type, level_cap, display_order, notes)
...
DECLARE
  ...
  v_route_id UUID;
BEGIN
  SELECT id INTO v_route_id FROM public.routes WHERE slug = 'icirrus-city' AND game_id = 'f2a3b4c5-d6e7-8901-f234-567890123456';
  INSERT INTO public.trainers (route_id, name, trainer_class, is_boss, boss_type, level_cap, display_order, notes)
...
DECLARE
  ...
  v_route_id UUID;
BEGIN
  SELECT id INTO v_route_id FROM public.routes WHERE slug = 'pokemon-league' AND game_id = 'f2a3b4c5-d6e7-8901-f234-567890123456';
  INSERT INTO public.trainers (route_id, name, trainer_class, is_boss, boss_type, level_cap, display_order, notes)
...
DECLARE
  ...
  v_route_id UUID;
BEGIN
  SELECT id INTO v_route_id FROM public.routes WHERE slug = 'opelucid-city' AND game_id = 'f2a3b4c5-d6e7-8901-f234-567890123456';
  INSERT INTO public.trainers (route_id, name, trainer_class, is_boss, boss_type, level_cap, display_order, notes)
  VALUES (v_route_id, 'Drayden', 'Gym Leader', true, 'gym_leader', 43, 1, 'Dragon-type specialist. Legend Badge. Black version.')
  RETURNING id INTO v_trainer_id;

  INSERT INTO public.trainer_pokemon (trainer_id, pokemon_national_dex_id, level, slot_order, moves, ability, held_item, nature)
  VALUES (v_trainer_id, 611, 41, 1, '["Dragon Tail", "Dragon Dance", "Assurance", "Slash"]'::jsonb, 'Rivalry', NULL, NULL);
  INSERT INTO public.trainer_pokemon (trainer_id, pokemon_national_dex_id, level, slot_order, moves, ability, held_item, nature)
  VALUES (v_trainer_id, 621, 41, 2, '["Dragon Tail", "Revenge", "Night Slash", "Crunch"]'::jsonb, 'Rough Skin', NULL, NULL);
  INSERT INTO public.trainer_pokemon (trainer_id, pokemon_national_dex_id, level, slot_order, moves, ability, held_item, nature)
  VALUES (v_trainer_id, 612, 43, 3, '["Dragon Tail", "Dragon Dance", "Slash", "Assurance"]'::jsonb, 'Rivalry', NULL, NULL);
END $$;
...
BEGIN
  SELECT id INTO v_route_id FROM public.routes WHERE slug = 'pokemon-league' AND game_id = 'f2a3b4c5-d6e7-8901-f234-567890123456';
  INSERT INTO public.trainers (route_id, name, trainer_class, is_boss, boss_type, level_cap, display_order, notes)
  VALUES (v_route_id, 'N', 'Champion', true, 'champion', 52, 5, 'Final rival battle. Team Plasma King. Zekrom in Black.')
  RETURNING id INTO v_trainer_id;

  INSERT INTO public.trainer_pokemon (trainer_id, pokemon_national_dex_id, level, slot_order, moves, ability, held_item, nature)
  VALUES (v_trainer_id, 644, 52, 1, '["Fusion Bolt", "Zen Headbutt", "Dragon Claw", "Giga Impact"]'::jsonb, 'Teravolt', NULL, NULL);
  INSERT INTO public.trainer_pokemon (trainer_id, pokemon_national_dex_id, level, slot_order, moves, ability, held_item, nature)
...
UPDATE public.games SET total_routes = 52 WHERE id = 'f2a3b4c5-d6e7-8901-f234-567890123456';
