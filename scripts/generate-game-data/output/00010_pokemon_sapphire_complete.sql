-- ===========================================
-- POKEMON SAPPHIRE: COMPLETE GAME DATA
-- Official Pokemon Game
-- Gen 3, Hoenn region
-- ===========================================
-- Game ID: b8c9d0e1-f2a3-4567-bc78-901234567890
-- ===========================================
...
VALUES (
  'b8c9d0e1-f2a3-4567-bc78-901234567890',
  'pokemon-sapphire',
  'Pokemon Sapphire',
  3,
  'Hoenn',
  ...
  66,
  'Pokemon Sapphire Version for Game Boy Advance. Set in the Hoenn region with Team Aqua as the villains.'
);

-- ===========================================
-- STEP 2: ALL ROUTES (66 total)
-- ===========================================

INSERT INTO public.routes (game_id, name, slug, display_order, route_type, has_encounters, has_trainers, has_items, notes) VALUES
('b8c9d0e1-f2a3-4567-bc78-901234567890', 'Littleroot Town', 'littleroot-town', 1, 'city', true, false, false, 'Starter town. Choose Treecko, Torchic, or Mudkip.'),
('b8c9d0e1-f2a3-4567-bc78-901234567890', 'Route 101', 'route-101', 2, 'route', true, false, false, NULL),
('b8c9d0e1-f2a3-4567-bc78-901234567890', 'Oldale Town', 'oldale-town', 3, 'city', false, false, true, NULL),
('b8c9d0e1-f2a3-4567-bc78-901234567890', 'Route 103', 'route-103', 4, 'route', true, true, false, NULL),
('b8c9d0e1-f2a3-4567-bc78-901234567890', 'Route 102', 'route-102', 5, 'route', true, true, true, NULL),
('b8c9d0e1-f2a3-4567-bc78-901234567890', 'Petalburg City', 'petalburg-city', 6, 'city', false, false, true, NULL),
('b8c9d0e1-f2a3-4567-bc78-901234567890', 'Route 104 (South)', 'route-104-south', 7, 'route', true, true, true, NULL),
('b8c9d0e1-f2a3-4567-bc78-901234567890', 'Petalburg Woods', 'petalburg-woods', 8, 'cave', true, true, true, NULL),
('b8c9d0e1-f2a3-4567-bc78-901234567890', 'Route 104 (North)', 'route-104-north', 9, 'route', true, true, true, NULL),
('b8c9d0e1-f2a3-4567-bc78-901234567890', 'Rustboro City', 'rustboro-city', 10, 'city', false, true, true, 'Gym Leader Roxanne. Rock-type specialist.'),
('b8c9d0e1-f2a3-4567-bc78-901234567890', 'Route 116', 'route-116', 11, 'route', true, true, true, NULL),
('b8c9d0e1-f2a3-4567-bc78-901234567890', 'Rusturf Tunnel', 'rusturf-tunnel', 12, 'cave', true, false, true, NULL),
('b8c9d0e1-f2a3-4567-bc78-901234567890', 'Route 105', 'route-105', 13, 'water', true, true, false, NULL),
('b8c9d0e1-f2a3-4567-bc78-901234567890', 'Dewford Town', 'dewford-town', 14, 'city', false, true, true, 'Gym Leader Brawly. Fighting-type specialist.'),
('b8c9d0e1-f2a3-4567-bc78-901234567890', 'Granite Cave', 'granite-cave', 15, 'cave', true, false, true, NULL),
('b8c9d0e1-f2a3-4567-bc78-901234567890', 'Route 106', 'route-106', 16, 'water', true, true, false, NULL),
('b8c9d0e1-f2a3-4567-bc78-901234567890', 'Route 107', 'route-107', 17, 'water', true, true, false, NULL),
('b8c9d0e1-f2a3-4567-bc78-901234567890', 'Route 108', 'route-108', 18, 'water', true, true, false, NULL),
('b8c9d0e1-f2a3-4567-bc78-901234567890', 'Route 109', 'route-109', 19, 'water', true, true, false, NULL),
('b8c9d0e1-f2a3-4567-bc78-901234567890', 'Slateport City', 'slateport-city', 20, 'city', false, false, true, NULL),
('b8c9d0e1-f2a3-4567-bc78-901234567890', 'Route 110', 'route-110', 21, 'route', true, true, true, 'Cycling Road. Rival battle here.'),
('b8c9d0e1-f2a3-4567-bc78-901234567890', 'Mauville City', 'mauville-city', 22, 'city', false, true, true, 'Gym Leader Wattson. Electric-type specialist.'),
('b8c9d0e1-f2a3-4567-bc78-901234567890', 'Route 117', 'route-117', 23, 'route', true, true, true, NULL),
('b8c9d0e1-f2a3-4567-bc78-901234567890', 'Verdanturf Town', 'verdanturf-town', 24, 'city', false, false, true, NULL),
('b8c9d0e1-f2a3-4567-bc78-901234567890', 'Route 111', 'route-111', 25, 'route', true, true, true, 'Features a desert area accessible with Go-Goggles.'),
('b8c9d0e1-f2a3-4567-bc78-901234567890', 'Route 112', 'route-112', 26, 'route', true, true, false, NULL),
('b8c9d0e1-f2a3-4567-bc78-901234567890', 'Fiery Path', 'fiery-path', 27, 'cave', true, false, true, NULL),
('b8c9d0e1-f2a3-4567-bc78-901234567890', 'Route 113', 'route-113', 28, 'route', true, true, true, 'Ash-covered route.'),
('b8c9d0e1-f2a3-4567-bc78-901234567890', 'Fallarbor Town', 'fallarbor-town', 29, 'city', false, false, true, NULL),
('b8c9d0e1-f2a3-4567-bc78-901234567890', 'Route 114', 'route-114', 30, 'route', true, true, true, NULL),
('b8c9d0e1-f2a3-4567-bc78-901234567890', 'Meteor Falls', 'meteor-falls', 31, 'cave', true, false, true, NULL),
('b8c9d0e1-f2a3-4567-bc78-901234567890', 'Route 115', 'route-115', 32, 'route', true, true, false, NULL),
('b8c9d0e1-f2a3-4567-bc78-901234567890', 'Mt. Chimney', 'mt-chimney', 33, 'special', false, true, false, 'Team confrontation at the summit.'),
('b8c9d0e1-f2a3-4567-bc78-901234567890', 'Jagged Pass', 'jagged-pass', 34, 'route', true, true, false, NULL),
('b8c9d0e1-f2a3-4567-bc78-901234567890', 'Lavaridge Town', 'lavaridge-town', 35, 'city', false, true, true, 'Gym Leader Flannery. Fire-type specialist.'),
('b8c9d0e1-f2a3-4567-bc78-901234567890', 'Petalburg City Gym', 'petalburg-city-gym', 36, 'building', false, true, false, 'Gym Leader Norman. Normal-type specialist.'),
('b8c9d0e1-f2a3-4567-bc78-901234567890', 'Route 118', 'route-118', 37, 'route', true, true, false, 'Requires Surf.'),
('b8c9d0e1-f2a3-4567-bc78-901234567890', 'Route 119', 'route-119', 38, 'route', true, true, true, 'Weather Institute.'),
('b8c9d0e1-f2a3-4567-bc78-901234567890', 'Fortree City', 'fortree-city', 39, 'city', false, true, true, 'Gym Leader Winona. Flying-type specialist.'),
('b8c9d0e1-f2a3-4567-bc78-901234567890', 'Route 120', 'route-120', 40, 'route', true, true, true, NULL),
('b8c9d0e1-f2a3-4567-bc78-901234567890', 'Route 121', 'route-121', 41, 'route', true, true, false, NULL),
('b8c9d0e1-f2a3-4567-bc78-901234567890', 'Mt. Pyre', 'mt-pyre', 42, 'cave', true, true, true, NULL),
('b8c9d0e1-f2a3-4567-bc78-901234567890', 'Route 122', 'route-122', 43, 'water', true, false, false, NULL),
('b8c9d0e1-f2a3-4567-bc78-901234567890', 'Lilycove City', 'lilycove-city', 44, 'city', false, false, true, NULL),
('b8c9d0e1-f2a3-4567-bc78-901234567890', 'Route 123', 'route-123', 45, 'route', true, true, true, NULL),
('b8c9d0e1-f2a3-4567-bc78-901234567890', 'Route 124', 'route-124', 46, 'water', true, true, false, NULL),
('b8c9d0e1-f2a3-4567-bc78-901234567890', 'Mossdeep City', 'mossdeep-city', 47, 'city', false, true, true, 'Gym Leaders Tate & Liza. Psychic-type specialists.'),
('b8c9d0e1-f2a3-4567-bc78-901234567890', 'Route 125', 'route-125', 48, 'water', true, true, false, NULL),
('b8c9d0e1-f2a3-4567-bc78-901234567890', 'Shoal Cave', 'shoal-cave', 49, 'cave', true, false, true, 'Tidal cave. Changes with tides.'),
('b8c9d0e1-f2a3-4567-bc78-901234567890', 'Route 126', 'route-126', 50, 'water', true, false, false, NULL),
('b8c9d0e1-f2a3-4567-bc78-901234567890', 'Route 127', 'route-127', 51, 'water', true, true, false, NULL),
('b8c9d0e1-f2a3-4567-bc78-901234567890', 'Route 128', 'route-128', 52, 'water', true, true, false, NULL),
('b8c9d0e1-f2a3-4567-bc78-901234567890', 'Seafloor Cavern', 'seafloor-cavern', 53, 'cave', true, true, false, NULL),
('b8c9d0e1-f2a3-4567-bc78-901234567890', 'Sootopolis City', 'sootopolis-city', 54, 'city', false, true, true, 'Gym Leader Wallace. Water-type specialist.'),
('b8c9d0e1-f2a3-4567-bc78-901234567890', 'Route 129', 'route-129', 55, 'water', true, false, false, NULL),
('b8c9d0e1-f2a3-4567-bc78-901234567890', 'Route 130', 'route-130', 56, 'water', true, false, false, NULL),
('b8c9d0e1-f2a3-4567-bc78-901234567890', 'Route 131', 'route-131', 57, 'water', true, false, false, NULL),
('b8c9d0e1-f2a3-4567-bc78-901234567890', 'Pacifidlog Town', 'pacifidlog-town', 58, 'city', false, false, true, NULL),
('b8c9d0e1-f2a3-4567-bc78-901234567890', 'Route 132', 'route-132', 59, 'water', true, false, false, NULL),
('b8c9d0e1-f2a3-4567-bc78-901234567890', 'Route 133', 'route-133', 60, 'water', true, false, false, NULL),
('b8c9d0e1-f2a3-4567-bc78-901234567890', 'Route 134', 'route-134', 61, 'water', true, false, false, NULL),
('b8c9d0e1-f2a3-4567-bc78-901234567890', 'Ever Grande City', 'ever-grande-city', 62, 'city', false, false, false, NULL),
('b8c9d0e1-f2a3-4567-bc78-901234567890', 'Victory Road', 'victory-road', 63, 'cave', true, true, true, NULL),
('b8c9d0e1-f2a3-4567-bc78-901234567890', 'Pokemon League', 'pokemon-league', 64, 'building', false, true, false, 'Elite Four and Champion Steven.'),
('b8c9d0e1-f2a3-4567-bc78-901234567890', 'New Mauville', 'new-mauville', 65, 'building', true, false, true, 'Electric-type Pokemon.'),
('b8c9d0e1-f2a3-4567-bc78-901234567890', 'Sky Pillar', 'sky-pillar', 66, 'building', true, false, false, 'Rayquaza at the top.');
...
FROM public.routes r WHERE r.slug = 'littleroot-town' AND r.game_id = 'b8c9d0e1-f2a3-4567-bc78-901234567890';
...
-- ===========================================
-- STEP 4: ENCOUNTER DATA (471 total)
-- ===========================================
...
('route-102', 270, 'walking', 20.00, 3, 4, NULL, NULL),
...
('granite-cave', 302, 'walking', 30.00, 9, 12, NULL, NULL),
...
('route-110', 311, 'walking', 15.00, 13, 13, NULL, NULL),
('route-110', 312, 'walking', 2.00, 12, 13, NULL, NULL),
...
('route-117', 313, 'walking', 18.00, 13, 14, NULL, NULL),
('route-117', 314, 'walking', 1.00, 13, 13, NULL, NULL),
...
('fiery-path', 88, 'walking', 25.00, 15, 16, NULL, NULL),
('fiery-path', 109, 'walking', 2.00, 14, 14, NULL, NULL),
...
('route-114', 270, 'walking', 30.00, 15, 16, NULL, NULL),
('route-114', 271, 'walking', 10.00, 16, 18, NULL, NULL),
...
('route-114', 336, 'walking', 19.00, 15, 17, NULL, NULL),
...
('meteor-falls', 337, 'surfing', 30.00, 5, 35, NULL, NULL),
('meteor-falls', 337, 'walking', 90.00, 14, 39, NULL, NULL),
...
('jagged-pass', 66, 'walking', 25.00, 20, 22, NULL, NULL),
('jagged-pass', 322, 'walking', 55.00, 20, 22, NULL, NULL),
('jagged-pass', 325, 'walking', 20.00, 20, 22, NULL, NULL),
...
('route-121', 353, 'walking', 30.00, 26, 28, NULL, NULL),
('mt-pyre', 353, 'walking', 695.00, 22, 30, NULL, NULL),
('mt-pyre', 355, 'walking', 43.00, 25, 30, NULL, NULL),
...
('route-123', 353, 'walking', 30.00, 26, 28, NULL, NULL),
...
('route-129', 321, 'surfing', 1.00, 25, 30, NULL, NULL),
...
('victory-road', 302, 'walking', 35.00, 40, 44, NULL, NULL),
...
('new-mauville', 100, 'static', 300.00, 25, 25, NULL, NULL),
('new-mauville', 101, 'walking', 1.00, 26, 26, NULL, NULL),
('sky-pillar', 42, 'walking', 90.00, 48, 56, NULL, NULL),
('sky-pillar', 302, 'walking', 90.00, 48, 56, NULL, NULL),
('sky-pillar', 344, 'walking', 69.00, 47, 56, NULL, NULL),
('sky-pillar', 354, 'walking', 45.00, 48, 56, NULL, NULL),
...
FROM _enc e JOIN public.routes r ON r.slug = e.slug AND r.game_id = 'b8c9d0e1-f2a3-4567-bc78-901234567890';
...
DECLARE
  ...
  v_route_id UUID;
BEGIN
  SELECT id INTO v_route_id FROM public.routes WHERE slug = 'rustboro-city' AND game_id = 'b8c9d0e1-f2a3-4567-bc78-901234567890';
  INSERT INTO public.trainers (route_id, name, trainer_class, is_boss, boss_type, level_cap, display_order, notes)
  VALUES (v_route_id, 'Roxanne', 'Gym Leader', true, 'gym_leader', 15, 1, 'Rock-type specialist. Stone Badge.')
  ...
  VALUES (v_trainer_id, 74, 12, 1, '["Tackle", "Defense Curl", "Rock Throw", "Rock Tomb"]'::jsonb, 'Rock Head', NULL, NULL);
  INSERT INTO public.trainer_pokemon (trainer_id, pokemon_national_dex_id, level, slot_order, moves, ability, held_item, nature)
  VALUES (v_trainer_id, 299, 15, 2, '["Rock Throw", "Harden", "Block", "Rock Tomb"]'::jsonb, 'Sturdy', NULL, NULL);
END $$;
...
DECLARE
  ...
  v_route_id UUID;
BEGIN
  SELECT id INTO v_route_id FROM public.routes WHERE slug = 'dewford-town' AND game_id = 'b8c9d0e1-f2a3-4567-bc78-901234567890';
  INSERT INTO public.trainers (route_id, name, trainer_class, is_boss, boss_type, level_cap, display_order, notes)
  VALUES (v_route_id, 'Brawly', 'Gym Leader', true, 'gym_leader', 19, 1, 'Fighting-type specialist. Knuckle Badge.')
  RETURNING id INTO v_trainer_id;

  INSERT INTO public.trainer_pokemon (trainer_id, pokemon_national_dex_id, level, slot_order, moves, ability, held_item, nature)
  VALUES (v_trainer_id, 66, 16, 1, '["Karate Chop", "Leer", "Seismic Toss", "Bulk Up"]'::jsonb, 'Guts', NULL, NULL);
  INSERT INTO public.trainer_pokemon (trainer_id, pokemon_national_dex_id, level, slot_order, moves, ability, held_item, nature)
  VALUES (v_trainer_id, 296, 19, 2, '["Arm Thrust", "Vital Throw", "Reversal", "Bulk Up"]'::jsonb, 'Thick Fat', NULL, NULL);
END $$;
...
DECLARE
  ...
  v_route_id UUID;
BEGIN
  SELECT id INTO v_route_id FROM public.routes WHERE slug = 'route-110' AND game_id = 'b8c9d0e1-f2a3-4567-bc78-901234567890';
  INSERT INTO public.trainers (route_id, name, trainer_class, is_boss, boss_type, level_cap, display_order, notes)
  VALUES (v_route_id, 'May/Brendan', 'Rival', true, 'rival', 20, 1, 'Second rival battle. Team varies by starter.')
  RETURNING id INTO v_trainer_id;

  INSERT INTO public.trainer_pokemon (trainer_id, pokemon_national_dex_id, level, slot_order, moves, ability, held_item, nature)
  VALUES (v_trainer_id, 218, 18, 1, '["Ember", "Rock Throw", "Light Screen", "Smog"]'::jsonb, 'Flame Body', NULL, NULL);
  INSERT INTO public.trainer_pokemon (trainer_id, pokemon_national_dex_id, level, slot_order, moves, ability, held_item, nature)
  VALUES (v_trainer_id, 271, 18, 2, '["Absorb", "Nature Power", "Fake Out", "Astonish"]'::jsonb, 'Swift Swim', NULL, NULL);
  INSERT INTO public.trainer_pokemon (trainer_id, pokemon_national_dex_id, level, slot_order, moves, ability, held_item, nature)
  VALUES (v_trainer_id, 253, 20, 3, '["Absorb", "Quick Attack", "Fury Cutter", "Pursuit"]'::jsonb, 'Overgrow', NULL, NULL);
END $$;
...
DECLARE
  ...
  v_route_id UUID;
BEGIN
  SELECT id INTO v_route_id FROM public.routes WHERE slug = 'mauville-city' AND game_id = 'b8c9d0e1-f2a3-4567-bc78-901234567890';
  INSERT INTO public.trainers (route_id, name, trainer_class, is_boss, boss_type, level_cap, display_order, notes)
  VALUES (v_route_id, 'Wattson', 'Gym Leader', true, 'gym_leader', 24, 1, 'Electric-type specialist. Dynamo Badge.')
  RETURNING id INTO v_trainer_id;

  INSERT INTO public.trainer_pokemon (trainer_id, pokemon_national_dex_id, level, slot_order, moves, ability, held_item, nature)
  VALUES (v_trainer_id, 100, 20, 1, '["Rollout", "Spark", "Self-Destruct", "Charge"]'::jsonb, 'Soundproof', NULL, NULL);
  INSERT INTO public.trainer_pokemon (trainer_id, pokemon_national_dex_id, level, slot_order, moves, ability, held_item, nature)
  VALUES (v_trainer_id, 309, 20, 2, '["Howl", "Quick Attack", "Spark", "Leer"]'::jsonb, 'Static', NULL, NULL);
  INSERT INTO public.trainer_pokemon (trainer_id, pokemon_national_dex_id, level, slot_order, moves, ability, held_item, nature)
  VALUES (v_trainer_id, 82, 22, 3, '["Sonic Boom", "Supersonic", "Thunder Wave", "Shock Wave"]'::jsonb, 'Magnet Pull', NULL, NULL);
END $$;
...
DECLARE
  ...
  v_route_id UUID;
BEGIN
  SELECT id INTO v_route_id FROM public.routes WHERE slug = 'lavaridge-town' AND game_id = 'b8c9d0e1-f2a3-4567-bc78-901234567890';
  INSERT INTO public.trainers (route_id, name, trainer_class, is_boss, boss_type, level_cap, display_order, notes)
  VALUES (v_route_id, 'Flannery', 'Gym Leader', true, 'gym_leader', 28, 1, 'Fire-type specialist. Heat Badge.')
  RETURNING id INTO v_trainer_id;

  INSERT INTO public.trainer_pokemon (trainer_id, pokemon_national_dex_id, level, slot_order, moves, ability, held_item, nature)
  VALUES (v_trainer_id, 322, 24, 1, '["Overheat", "Tackle", "Magnitude", "Sunny Day"]'::jsonb, 'Oblivious', NULL, NULL);
  INSERT INTO public.trainer_pokemon (trainer_id, pokemon_national_dex_id, level, slot_order, moves, ability, held_item, nature)
  VALUES (v_trainer_id, 218, 24, 2, '["Overheat", "Smog", "Light Screen", "Sunny Day"]'::jsonb, 'Flame Body', NULL, NULL);
  INSERT INTO public.trainer_pokemon (trainer_id, pokemon_national_dex_id, level, slot_order, moves, ability, held_item, nature)
  VALUES (v_trainer_id, 324, 28, 3, '["Overheat", "Body Slam", "Flail", "Attract"]'::jsonb, 'White Smoke', NULL, NULL);
END $$;
...
DECLARE
  ...
  v_route_id UUID;
BEGIN
  SELECT id INTO v_route_id FROM public.routes WHERE slug = 'petalburg-city-gym' AND game_id = 'b8c9d0e1-f2a3-4567-bc78-901234567890';
  INSERT INTO public.trainers (route_id, name, trainer_class, is_boss, boss_type, level_cap, display_order, notes)
  VALUES (v_route_id, 'Norman', 'Gym Leader', true, 'gym_leader', 31, 1, 'Normal-type specialist. Balance Badge.')
  RETURNING id INTO v_trainer_id;

  INSERT INTO public.trainer_pokemon (trainer_id, pokemon_national_dex_id, level, slot_order, moves, ability, held_item, nature)
  VALUES (v_trainer_id, 327, 27, 1, '["Teeter Dance", "Psybeam", "Facade", "Encore"]'::jsonb, 'Own Tempo', NULL, NULL);
  INSERT INTO public.trainer_pokemon (trainer_id, pokemon_national_dex_id, level, slot_order, moves, ability, held_item, nature)
  VALUES (v_trainer_id, 288, 27, 2, '["Slash", "Faint Attack", "Facade", "Encore"]'::jsonb, 'Vital Spirit', NULL, NULL);
  INSERT INTO public.trainer_pokemon (trainer_id, pokemon_national_dex_id, level, slot_order, moves, ability, held_item, nature)
  VALUES (v_trainer_id, 264, 29, 3, '["Slash", "Belly Drum", "Headbutt", "Facade"]'::jsonb, 'Pickup', NULL, NULL);
  INSERT INTO public.trainer_pokemon (trainer_id, pokemon_national_dex_id, level, slot_order, moves, ability, held_item, nature)
  VALUES (v_trainer_id, 289, 31, 4, '["Counter", "Yawn", "Facade", "Faint Attack"]'::jsonb, 'Truant', NULL, NULL);
END $$;
...
DECLARE
  ...
  v_route_id UUID;
BEGIN
  SELECT id INTO v_route_id FROM public.routes WHERE slug = 'fortree-city' AND game_id = 'b8c9d0e1-f2a3-4567-bc78-901234567890';
  INSERT INTO public.trainers (route_id, name, trainer_class, is_boss, boss_type, level_cap, display_order, notes)
  VALUES (v_route_id, 'Winona', 'Gym Leader', true, 'gym_leader', 33, 1, 'Flying-type specialist. Feather Badge.')
  RETURNING id INTO v_trainer_id;

  INSERT INTO public.trainer_pokemon (trainer_id, pokemon_national_dex_id, level, slot_order, moves, ability, held_item, nature)
  VALUES (v_trainer_id, 333, 29, 1, '["Perish Song", "Mirror Move", "Safeguard", "Aerial Ace"]'::jsonb, 'Natural Cure', NULL, NULL);
  INSERT INTO public.trainer_pokemon (trainer_id, pokemon_national_dex_id, level, slot_order, moves, ability, held_item, nature)
  VALUES (v_trainer_id, 357, 29, 2, '["Sunny Day", "Aerial Ace", "Solar Beam", "Synthesis"]'::jsonb, 'Chlorophyll', NULL, NULL);
  INSERT INTO public.trainer_pokemon (trainer_id, pokemon_national_dex_id, level, slot_order, moves, ability, held_item, nature)
  VALUES (v_trainer_id, 279, 30, 3, '["Water Gun", "Supersonic", "Protect", "Aerial Ace"]'::jsonb, 'Keen Eye', NULL, NULL);
  INSERT INTO public.trainer_pokemon (trainer_id, pokemon_national_dex_id, level, slot_order, moves, ability, held_item, nature)
  VALUES (v_trainer_id, 227, 31, 4, '["Sand Attack", "Fury Attack", "Steel Wing", "Aerial Ace"]'::jsonb, 'Keen Eye', NULL, NULL);
  INSERT INTO public.trainer_pokemon (trainer_id, pokemon_national_dex_id, level, slot_order, moves, ability, held_item, nature)
  VALUES (v_trainer_id, 334, 33, 5, '["Dragon Dance", "DragonBreath", "Aerial Ace", "Earthquake"]'::jsonb, 'Natural Cure', NULL, NULL);
END $$;
...
DECLARE
  ...
  v_route_id UUID;
BEGIN
  SELECT id INTO v_route_id FROM public.routes WHERE slug = 'mossdeep-city' AND game_id = 'b8c9d0e1-f2a3-4567-bc78-901234567890';
  INSERT INTO public.trainers (route_id, name, trainer_class, is_boss, boss_type, level_cap, display_order, notes)
  VALUES (v_route_id, 'Tate & Liza', 'Gym Leader', true, 'gym_leader', 42, 1, 'Psychic-type specialists. Mind Badge. Double battle.')
  RETURNING id INTO v_trainer_id;

  INSERT INTO public.trainer_pokemon (trainer_id, pokemon_national_dex_id, level, slot_order, moves, ability, held_item, nature)
  VALUES (v_trainer_id, 338, 42, 1, '["Sunny Day", "Solar Beam", "Psychic", "Flamethrower"]'::jsonb, 'Levitate', NULL, NULL);
  INSERT INTO public.trainer_pokemon (trainer_id, pokemon_national_dex_id, level, slot_order, moves, ability, held_item, nature)
  VALUES (v_trainer_id, 337, 42, 2, '["Hypnosis", "Calm Mind", "Psychic", "Light Screen"]'::jsonb, 'Levitate', NULL, NULL);
END $$;
...
DECLARE
  ...
  v_route_id UUID;
BEGIN
  SELECT id INTO v_route_id FROM public.routes WHERE slug = 'sootopolis-city' AND game_id = 'b8c9d0e1-f2a3-4567-bc78-901234567890';
  INSERT INTO public.trainers (route_id, name, trainer_class, is_boss, boss_type, level_cap, display_order, notes)
  VALUES (v_route_id, 'Wallace', 'Gym Leader', true, 'gym_leader', 43, 1, 'Water-type specialist. Rain Badge.')
  RETURNING id INTO v_trainer_id;

  INSERT INTO public.trainer_pokemon (trainer_id, pokemon_national_dex_id, level, slot_order, moves, ability, held_item, nature)
  VALUES (v_trainer_id, 370, 40, 1, '["Water Pulse", "Attract", "Sweet Kiss", "Flail"]'::jsonb, 'Swift Swim', NULL, NULL);
  INSERT INTO public.trainer_pokemon (trainer_id, pokemon_national_dex_id, level, slot_order, moves, ability, held_item, nature)
  VALUES (v_trainer_id, 340, 42, 2, '["Rain Dance", "Water Pulse", "Amnesia", "Earthquake"]'::jsonb, 'Oblivious', NULL, NULL);
  INSERT INTO public.trainer_pokemon (trainer_id, pokemon_national_dex_id, level, slot_order, moves, ability, held_item, nature)
  VALUES (v_trainer_id, 364, 40, 3, '["Encore", "Body Slam", "Aurora Beam", "Water Pulse"]'::jsonb, 'Thick Fat', NULL, NULL);
  INSERT INTO public.trainer_pokemon (trainer_id, pokemon_national_dex_id, level, slot_order, moves, ability, held_item, nature)
  VALUES (v_trainer_id, 119, 42, 4, '["Water Pulse", "Rain Dance", "Fury Attack", "Horn Drill"]'::jsonb, 'Swift Swim', NULL, NULL);
  INSERT INTO public.trainer_pokemon (trainer_id, pokemon_national_dex_id, level, slot_order, moves, ability, held_item, nature)
  VALUES (v_trainer_id, 350, 43, 5, '["Water Pulse", "Twister", "Recover", "Ice Beam"]'::jsonb, 'Marvel Scale', NULL, NULL);
END $$;
...
DECLARE
  ...
  v_route_id UUID;
BEGIN
  SELECT id INTO v_route_id FROM public.routes WHERE slug = 'pokemon-league' AND game_id = 'b8c9d0e1-f2a3-4567-bc78-901234567890';
  INSERT INTO public.trainers (route_id, name, trainer_class, is_boss, boss_type, level_cap, display_order, notes)
  VALUES (v_route_id, 'Sidney', 'Elite Four', true, 'elite_four', 49, 1, 'Dark-type specialist. First of the Elite Four.')
  RETURNING id INTO v_trainer_id;

  INSERT INTO public.trainer_pokemon (trainer_id, pokemon_national_dex_id, level, slot_order, moves, ability, held_item, nature)
  VALUES (v_trainer_id, 262, 46, 1, '["Crunch", "Sand Attack", "Take Down", "Swagger"]'::jsonb, 'Intimidate', NULL, NULL);
  INSERT INTO public.trainer_pokemon (trainer_id, pokemon_national_dex_id, level, slot_order, moves, ability, held_item, nature)
  VALUES (v_trainer_id, 275, 48, 2, '["Fake Out", "Double Team", "Swagger", "Extrasensory"]'::jsonb, 'Chlorophyll', NULL, NULL);
  INSERT INTO public.trainer_pokemon (trainer_id, pokemon_national_dex_id, level, slot_order, moves, ability, held_item, nature)
  VALUES (v_trainer_id, 359, 49, 3, '["Swords Dance", "Slash", "Aerial Ace", "Crunch"]'::jsonb, 'Pressure', NULL, NULL);
  INSERT INTO public.trainer_pokemon (trainer_id, pokemon_national_dex_id, level, slot_order, moves, ability, held_item, nature)
  VALUES (v_trainer_id, 332, 46, 4, '["Needle Arm", "Faint Attack", "Cotton Spore", "Leech Seed"]'::jsonb, 'Sand Veil', NULL, NULL);
  INSERT INTO public.trainer_pokemon (trainer_id, pokemon_national_dex_id, level, slot_order, moves, ability, held_item, nature)
  VALUES (v_trainer_id, 319, 48, 5, '["Surf", "Crunch", "Slash", "Swagger"]'::jsonb, 'Rough Skin', NULL, NULL);
END $$;
...
BEGIN
  SELECT id INTO v_route_id FROM public.routes WHERE slug = 'pokemon-league' AND game_id = 'b8c9d0e1-f2a3-4567-bc78-901234567890';
  INSERT INTO public.trainers (route_id, name, trainer_class, is_boss, boss_type, level_cap, display_order, notes)
  VALUES (v_route_id, 'Phoebe', 'Elite Four', true, 'elite_four', 51, 2, 'Ghost-type specialist. Second of the Elite Four.')
  RETURNING id INTO v_trainer_id;

  INSERT INTO public.trainer_pokemon (trainer_id, pokemon_national_dex_id, level, slot_order, moves, ability, held_item, nature)
  VALUES (v_trainer_id, 356, 48, 1, '["Shadow Punch", "Confuse Ray", "Curse", "Protect"]'::jsonb, 'Pressure', NULL, NULL);
  INSERT INTO public.trainer_pokemon (trainer_id, pokemon_national_dex_id, level, slot_order, moves, ability, held_item, nature)
  VALUES (v_trainer_id, 354, 49, 2, '["Shadow Ball", "Grudge", "Will-O-Wisp", "Faint Attack"]'::jsonb, 'Insomnia', NULL, NULL);
  INSERT INTO public.trainer_pokemon (trainer_id, pokemon_national_dex_id, level, slot_order, moves, ability, held_item, nature)
  VALUES (v_trainer_id, 302, 50, 3, '["Shadow Ball", "Faint Attack", "Double Team", "Attract"]'::jsonb, 'Keen Eye', NULL, NULL);
  INSERT INTO public.trainer_pokemon (trainer_id, pokemon_national_dex_id, level, slot_order, moves, ability, held_item, nature)
  VALUES (v_trainer_id, 354, 49, 4, '["Shadow Ball", "Psychic", "Thunderbolt", "Toxic"]'::jsonb, 'Insomnia', NULL, NULL);
  INSERT INTO public.trainer_pokemon (trainer_id, pokemon_national_dex_id, level, slot_order, moves, ability, held_item, nature)
  VALUES (v_trainer_id, 356, 51, 5, '["Shadow Ball", "Ice Beam", "Rock Slide", "Earthquake"]'::jsonb, 'Pressure', NULL, NULL);
END $$;
...
BEGIN
  SELECT id INTO v_route_id FROM public.routes WHERE slug = 'pokemon-league' AND game_id = 'b8c9d0e1-f2a3-4567-bc78-901234567890';
  INSERT INTO public.trainers (route_id, name, trainer_class, is_boss, boss_type, level_cap, display_order, notes)
  VALUES (v_route_id, 'Glacia', 'Elite Four', true, 'elite_four', 53, 3, 'Ice-type specialist. Third of the Elite Four.')
  RETURNING id INTO v_trainer_id;

  INSERT INTO public.trainer_pokemon (trainer_id, pokemon_national_dex_id, level, slot_order, moves, ability, held_item, nature)
  VALUES (v_trainer_id, 364, 50, 1, '["Encore", "Body Slam", "Hail", "Ice Ball"]'::jsonb, 'Thick Fat', NULL, NULL);
  INSERT INTO public.trainer_pokemon (trainer_id, pokemon_national_dex_id, level, slot_order, moves, ability, held_item, nature)
  VALUES (v_trainer_id, 362, 50, 2, '["Light Screen", "Crunch", "Icy Wind", "Ice Beam"]'::jsonb, 'Inner Focus', NULL, NULL);
  INSERT INTO public.trainer_pokemon (trainer_id, pokemon_national_dex_id, level, slot_order, moves, ability, held_item, nature)
  VALUES (v_trainer_id, 364, 52, 3, '["Attract", "Double Edge", "Hail", "Blizzard"]'::jsonb, 'Thick Fat', NULL, NULL);
  INSERT INTO public.trainer_pokemon (trainer_id, pokemon_national_dex_id, level, slot_order, moves, ability, held_item, nature)
  VALUES (v_trainer_id, 362, 52, 4, '["Shadow Ball", "Hail", "Ice Beam", "Crunch"]'::jsonb, 'Inner Focus', NULL, NULL);
  INSERT INTO public.trainer_pokemon (trainer_id, pokemon_national_dex_id, level, slot_order, moves, ability, held_item, nature)
  VALUES (v_trainer_id, 365, 53, 5, '["Surf", "Body Slam", "Ice Beam", "Sheer Cold"]'::jsonb, 'Thick Fat', NULL, NULL);
END $$;
...
BEGIN
  SELECT id INTO v_route_id FROM public.routes WHERE slug = 'pokemon-league' AND game_id = 'b8c9d0e1-f2a3-4567-bc78-901234567890';
  INSERT INTO public.trainers (route_id, name, trainer_class, is_boss, boss_type, level_cap, display_order, notes)
  VALUES (v_route_id, 'Drake', 'Elite Four', true, 'elite_four', 55, 4, 'Dragon-type specialist. Fourth of the Elite Four.')
  RETURNING id INTO v_trainer_id;

  INSERT INTO public.trainer_pokemon (trainer_id, pokemon_national_dex_id, level, slot_order, moves, ability, held_item, nature)
  VALUES (v_trainer_id, 372, 52, 1, '["Rock Tomb", "Dragon Claw", "Protect", "Double Edge"]'::jsonb, 'Rock Head', NULL, NULL);
  INSERT INTO public.trainer_pokemon (trainer_id, pokemon_national_dex_id, level, slot_order, moves, ability, held_item, nature)
  VALUES (v_trainer_id, 334, 54, 2, '["Dragon Dance", "Refresh", "DragonBreath", "Aerial Ace"]'::jsonb, 'Natural Cure', NULL, NULL);
  INSERT INTO public.trainer_pokemon (trainer_id, pokemon_national_dex_id, level, slot_order, moves, ability, held_item, nature)
  VALUES (v_trainer_id, 330, 53, 3, '["Flamethrower", "Crunch", "DragonBreath", "Screech"]'::jsonb, 'Levitate', NULL, NULL);
  INSERT INTO public.trainer_pokemon (trainer_id, pokemon_national_dex_id, level, slot_order, moves, ability, held_item, nature)
  VALUES (v_trainer_id, 330, 53, 4, '["Fly", "Crunch", "DragonBreath", "Dig"]'::jsonb, 'Levitate', NULL, NULL);
  INSERT INTO public.trainer_pokemon (trainer_id, pokemon_national_dex_id, level, slot_order, moves, ability, held_item, nature)
  VALUES (v_trainer_id, 373, 55, 5, '["Flamethrower", "Dragon Claw", "Rock Slide", "Crunch"]'::jsonb, 'Intimidate', NULL, NULL);
END $$;
...
BEGIN
  SELECT id INTO v_route_id FROM public.routes WHERE slug = 'pokemon-league' AND game_id = 'b8c9d0e1-f2a3-4567-bc78-901234567890';
  INSERT INTO public.trainers (route_id, name, trainer_class, is_boss, boss_type, level_cap, display_order, notes)
  VALUES (v_route_id, 'Steven', 'Champion', true, 'champion', 58, 5, 'Steel-type specialist. Hoenn Champion in Ruby/Sapphire.')
  RETURNING id INTO v_trainer_id;

  INSERT INTO public.trainer_pokemon (trainer_id, pokemon_national_dex_id, level, slot_order, moves, ability, held_item, nature)
  VALUES (v_trainer_id, 227, 57, 1, '["Toxic", "Steel Wing", "Aerial Ace", "Spikes"]'::jsonb, 'Keen Eye', NULL, NULL);
  INSERT INTO public.trainer_pokemon (trainer_id, pokemon_national_dex_id, level, slot_order, moves, ability, held_item, nature)
  VALUES (v_trainer_id, 344, 55, 2, '["Earthquake", "AncientPower", "Light Screen", "Reflect"]'::jsonb, 'Levitate', NULL, NULL);
  INSERT INTO public.trainer_pokemon (trainer_id, pokemon_national_dex_id, level, slot_order, moves, ability, held_item, nature)
  VALUES (v_trainer_id, 306, 56, 3, '["Earthquake", "Dragon Claw", "Thunder", "SolarBeam"]'::jsonb, 'Sturdy', NULL, NULL);
  INSERT INTO public.trainer_pokemon (trainer_id, pokemon_national_dex_id, level, slot_order, moves, ability, held_item, nature)
  VALUES (v_trainer_id, 346, 56, 4, '["AncientPower", "Confuse Ray", "Sludge Bomb", "Giga Drain"]'::jsonb, 'Suction Cups', NULL, NULL);
  INSERT INTO public.trainer_pokemon (trainer_id, pokemon_national_dex_id, level, slot_order, moves, ability, held_item, nature)
  VALUES (v_trainer_id, 348, 56, 5, '["AncientPower", "Slash", "Aerial Ace", "Water Pulse"]'::jsonb, 'Battle Armor', NULL, NULL);
  INSERT INTO public.trainer_pokemon (trainer_id, pokemon_national_dex_id, level, slot_order, moves, ability, held_item, nature)
  VALUES (v_trainer_id, 376, 58, 6, '["Meteor Mash", "Earthquake", "Psychic", "Hyper Beam"]'::jsonb, 'Clear Body', 'Sitrus Berry', NULL);
END $$;

-- Update total_routes count
UPDATE public.games SET total_routes = 66 WHERE id = 'b8c9d0e1-f2a3-4567-bc78-901234567890';
