-- ===========================================
-- POKEMON HEARTGOLD: COMPLETE GAME DATA
-- Official Pokemon Game
-- Gen 4, Johto region
-- ===========================================
-- Game ID: c9d0e1f2-a3b4-5678-cd89-012345678901
-- ===========================================
...
VALUES (
  'c9d0e1f2-a3b4-5678-cd89-012345678901',
  'pokemon-heartgold',
  'Pokemon HeartGold',
  4,
  'Johto',
  ...
  90,
  'Pokemon HeartGold Version for Nintendo DS. A Gen 4 remake of Pokemon Gold, featuring Johto and Kanto regions. Ho-Oh on the cover.'
);
...
('c9d0e1f2-a3b4-5678-cd89-012345678901', 'New Bark Town', 'new-bark-town', 1, 'city', true, false, false, 'Starter town. Choose Chikorita, Cyndaquil, or Totodile.'),
('c9d0e1f2-a3b4-5678-cd89-012345678901', 'Route 29', 'route-29', 2, 'route', true, false, false, NULL),
('c9d0e1f2-a3b4-5678-cd89-012345678901', 'Route 46', 'route-46', 3, 'route', true, false, false, NULL),
('c9d0e1f2-a3b4-5678-cd89-012345678901', 'Cherrygrove City', 'cherrygrove-city', 4, 'city', true, false, false, 'Surf and fishing available.'),
('c9d0e1f2-a3b4-5678-cd89-012345678901', 'Route 30', 'route-30', 5, 'route', true, false, false, NULL),
('c9d0e1f2-a3b4-5678-cd89-012345678901', 'Route 31', 'route-31', 6, 'route', true, false, false, NULL),
('c9d0e1f2-a3b4-5678-cd89-012345678901', 'Dark Cave (Violet Side)', 'dark-cave-violet', 7, 'cave', true, false, false, NULL),
('c9d0e1f2-a3b4-5678-cd89-012345678901', 'Violet City', 'violet-city', 8, 'city', false, true, false, 'Gym Leader Falkner. Flying-type specialist.'),
('c9d0e1f2-a3b4-5678-cd89-012345678901', 'Sprout Tower', 'sprout-tower', 9, 'building', true, true, false, NULL),
('c9d0e1f2-a3b4-5678-cd89-012345678901', 'Route 32', 'route-32', 10, 'route', true, true, false, NULL),
('c9d0e1f2-a3b4-5678-cd89-012345678901', 'Ruins of Alph', 'ruins-of-alph', 11, 'special', true, false, false, 'Unown puzzle area.'),
('c9d0e1f2-a3b4-5678-cd89-012345678901', 'Union Cave', 'union-cave', 12, 'cave', true, true, false, NULL),
('c9d0e1f2-a3b4-5678-cd89-012345678901', 'Route 33', 'route-33', 13, 'route', true, false, false, NULL),
('c9d0e1f2-a3b4-5678-cd89-012345678901', 'Azalea Town', 'azalea-town', 14, 'city', false, true, false, 'Gym Leader Bugsy. Bug-type specialist.'),
('c9d0e1f2-a3b4-5678-cd89-012345678901', 'Slowpoke Well', 'slowpoke-well', 15, 'cave', true, false, false, NULL),
('c9d0e1f2-a3b4-5678-cd89-012345678901', 'Ilex Forest', 'ilex-forest', 16, 'route', true, false, false, NULL),
('c9d0e1f2-a3b4-5678-cd89-012345678901', 'Route 34', 'route-34', 17, 'route', true, true, false, NULL),
('c9d0e1f2-a3b4-5678-cd89-012345678901', 'Goldenrod City', 'goldenrod-city', 18, 'city', false, true, true, 'Gym Leader Whitney. Normal-type specialist.'),
('c9d0e1f2-a3b4-5678-cd89-012345678901', 'Route 35', 'route-35', 19, 'route', true, true, false, NULL),
('c9d0e1f2-a3b4-5678-cd89-012345678901', 'National Park', 'national-park', 20, 'route', true, false, false, 'Bug Catching Contest area.'),
('c9d0e1f2-a3b4-5678-cd89-012345678901', 'Route 36', 'route-36', 21, 'route', true, true, false, NULL),
('c9d0e1f2-a3b4-5678-cd89-012345678901', 'Route 37', 'route-37', 22, 'route', true, true, false, NULL),
('c9d0e1f2-a3b4-5678-cd89-012345678901', 'Ecruteak City', 'ecruteak-city', 23, 'city', false, true, false, 'Gym Leader Morty. Ghost-type specialist.'),
('c9d0e1f2-a3b4-5678-cd89-012345678901', 'Burned Tower', 'burned-tower', 24, 'building', true, false, false, 'Legendary beasts flee here.'),
('c9d0e1f2-a3b4-5678-cd89-012345678901', 'Route 38', 'route-38', 25, 'route', true, true, false, NULL),
('c9d0e1f2-a3b4-5678-cd89-012345678901', 'Route 39', 'route-39', 26, 'route', true, true, false, NULL),
('c9d0e1f2-a3b4-5678-cd89-012345678901', 'Olivine City', 'olivine-city', 27, 'city', false, true, false, 'Gym Leader Jasmine. Steel-type specialist.'),
('c9d0e1f2-a3b4-5678-cd89-012345678901', 'Route 40', 'route-40', 28, 'water', true, true, false, NULL),
('c9d0e1f2-a3b4-5678-cd89-012345678901', 'Route 41', 'route-41', 29, 'water', true, true, false, 'Whirl Islands nearby.'),
('c9d0e1f2-a3b4-5678-cd89-012345678901', 'Cianwood City', 'cianwood-city', 30, 'city', false, true, false, 'Gym Leader Chuck. Fighting-type specialist.'),
('c9d0e1f2-a3b4-5678-cd89-012345678901', 'Route 42', 'route-42', 31, 'route', true, true, false, NULL),
('c9d0e1f2-a3b4-5678-cd89-012345678901', 'Mt. Mortar', 'mt-mortar', 32, 'cave', true, false, true, NULL),
('c9d0e1f2-a3b4-5678-cd89-012345678901', 'Mahogany Town', 'mahogany-town', 33, 'city', false, true, false, 'Gym Leader Pryce. Ice-type specialist.'),
('c9d0e1f2-a3b4-5678-cd89-012345678901', 'Route 43', 'route-43', 34, 'route', true, true, false, NULL),
('c9d0e1f2-a3b4-5678-cd89-012345678901', 'Lake of Rage', 'lake-of-rage', 35, 'water', true, false, false, 'Red Gyarados event.'),
('c9d0e1f2-a3b4-5678-cd89-012345678901', 'Route 44', 'route-44', 36, 'route', true, true, false, NULL),
('c9d0e1f2-a3b4-5678-cd89-012345678901', 'Ice Path', 'ice-path', 37, 'cave', true, false, true, NULL),
('c9d0e1f2-a3b4-5678-cd89-012345678901', 'Blackthorn City', 'blackthorn-city', 38, 'city', false, true, false, 'Gym Leader Clair. Dragon-type specialist.'),
('c9d0e1f2-a3b4-5678-cd89-012345678901', 'Dragon''s Den', 'dragons-den', 39, 'cave', true, false, false, 'Dratini fishing.'),
('c9d0e1f2-a3b4-5678-cd89-012345678901', 'Route 45', 'route-45', 40, 'route', true, true, false, NULL),
('c9d0e1f2-a3b4-5678-cd89-012345678901', 'Dark Cave (Blackthorn Side)', 'dark-cave-blackthorn', 41, 'cave', true, false, false, NULL),
('c9d0e1f2-a3b4-5678-cd89-012345678901', 'Whirl Islands', 'whirl-islands', 42, 'cave', true, false, false, 'Lugia (SoulSilver).'),
('c9d0e1f2-a3b4-5678-cd89-012345678901', 'Route 27', 'route-27', 43, 'route', true, true, false, NULL),
('c9d0e1f2-a3b4-5678-cd89-012345678901', 'Tohjo Falls', 'tohjo-falls', 44, 'cave', true, false, false, NULL),
('c9d0e1f2-a3b4-5678-cd89-012345678901', 'Route 26', 'route-26', 45, 'route', true, true, false, NULL),
('c9d0e1f2-a3b4-5678-cd89-012345678901', 'Victory Road', 'victory-road', 46, 'cave', true, true, true, NULL),
('c9d0e1f2-a3b4-5678-cd89-012345678901', 'Indigo Plateau', 'indigo-plateau', 47, 'building', false, true, true, 'Elite Four and Champion Lance.'),
('c9d0e1f2-a3b4-5678-cd89-012345678901', 'Vermilion City', 'vermilion-city', 48, 'city', false, true, false, 'Gym Leader Lt. Surge. Electric-type specialist.'),
('c9d0e1f2-a3b4-5678-cd89-012345678901', 'Route 6', 'route-6', 49, 'route', true, true, false, NULL),
('c9d0e1f2-a3b4-5678-cd89-012345678901', 'Saffron City', 'saffron-city', 50, 'city', false, true, false, 'Gym Leader Sabrina. Psychic-type specialist.'),
('c9d0e1f2-a3b4-5678-cd89-012345678901', 'Route 5', 'route-5', 51, 'route', true, false, false, NULL),
('c9d0e1f2-a3b4-5678-cd89-012345678901', 'Cerulean City', 'cerulean-city', 52, 'city', false, true, false, 'Gym Leader Misty. Water-type specialist.'),
('c9d0e1f2-a3b4-5678-cd89-012345678901', 'Route 24', 'route-24', 53, 'route', true, true, false, NULL),
('c9d0e1f2-a3b4-5678-cd89-012345678901', 'Route 25', 'route-25', 54, 'route', true, true, false, NULL),
('c9d0e1f2-a3b4-5678-cd89-012345678901', 'Route 9', 'route-9', 55, 'route', true, true, false, NULL),
('c9d0e1f2-a3b4-5678-cd89-012345678901', 'Route 10', 'route-10', 56, 'route', true, false, false, NULL),
('c9d0e1f2-a3b4-5678-cd89-012345678901', 'Rock Tunnel', 'rock-tunnel', 57, 'cave', true, true, false, NULL),
('c9d0e1f2-a3b4-5678-cd89-012345678901', 'Lavender Town', 'lavender-town', 58, 'city', false, false, false, NULL),
('c9d0e1f2-a3b4-5678-cd89-012345678901', 'Route 8', 'route-8', 59, 'route', true, true, false, NULL),
('c9d0e1f2-a3b4-5678-cd89-012345678901', 'Route 7', 'route-7', 60, 'route', true, false, false, NULL),
('c9d0e1f2-a3b4-5678-cd89-012345678901', 'Celadon City', 'celadon-city', 61, 'city', false, true, true, 'Gym Leader Erika. Grass-type specialist.'),
('c9d0e1f2-a3b4-5678-cd89-012345678901', 'Route 16', 'route-16', 62, 'route', true, false, false, NULL),
('c9d0e1f2-a3b4-5678-cd89-012345678901', 'Route 17', 'route-17', 63, 'route', true, true, false, 'Cycling Road.'),
('c9d0e1f2-a3b4-5678-cd89-012345678901', 'Route 18', 'route-18', 64, 'route', true, false, false, NULL),
('c9d0e1f2-a3b4-5678-cd89-012345678901', 'Fuchsia City', 'fuchsia-city', 65, 'city', false, true, false, 'Gym Leader Janine. Poison-type specialist.'),
('c9d0e1f2-a3b4-5678-cd89-012345678901', 'Route 15', 'route-15', 66, 'route', true, true, false, NULL),
('c9d0e1f2-a3b4-5678-cd89-012345678901', 'Route 14', 'route-14', 67, 'route', true, true, false, NULL),
('c9d0e1f2-a3b4-5678-cd89-012345678901', 'Route 13', 'route-13', 68, 'route', true, true, false, NULL),
('c9d0e1f2-a3b4-5678-cd89-012345678901', 'Route 12', 'route-12', 69, 'route', true, true, false, NULL),
('c9d0e1f2-a3b4-5678-cd89-012345678901', 'Route 11', 'route-11', 70, 'route', true, true, false, NULL),
('c9d0e1f2-a3b4-5678-cd89-012345678901', 'Diglett''s Cave', 'digletts-cave', 71, 'cave', true, false, false, NULL),
('c9d0e1f2-a3b4-5678-cd89-012345678901', 'Route 2', 'route-2', 72, 'route', true, false, false, NULL),
('c9d0e1f2-a3b4-5678-cd89-012345678901', 'Pewter City', 'pewter-city', 73, 'city', false, true, false, 'Gym Leader Brock. Rock-type specialist.'),
('c9d0e1f2-a3b4-5678-cd89-012345678901', 'Viridian Forest', 'viridian-forest', 74, 'route', true, false, false, NULL),
('c9d0e1f2-a3b4-5678-cd89-012345678901', 'Viridian City', 'viridian-city', 75, 'city', false, true, false, 'Gym Leader Blue. Mixed-type specialist.'),
('c9d0e1f2-a3b4-5678-cd89-012345678901', 'Route 1', 'route-1', 76, 'route', true, false, false, NULL),
('c9d0e1f2-a3b4-5678-cd89-012345678901', 'Pallet Town', 'pallet-town', 77, 'city', true, false, false, 'Surf and fishing available.'),
('c9d0e1f2-a3b4-5678-cd89-012345678901', 'Route 21', 'route-21', 78, 'water', true, true, false, NULL),
('c9d0e1f2-a3b4-5678-cd89-012345678901', 'Cinnabar Island', 'cinnabar-island', 79, 'city', false, true, false, 'Gym Leader Blaine. Fire-type specialist.'),
('c9d0e1f2-a3b4-5678-cd89-012345678901', 'Route 20', 'route-20', 80, 'water', true, true, false, NULL),
('c9d0e1f2-a3b4-5678-cd89-012345678901', 'Route 19', 'route-19', 81, 'water', true, true, false, NULL),
('c9d0e1f2-a3b4-5678-cd89-012345678901', 'Seafoam Islands', 'seafoam-islands', 82, 'cave', true, false, true, NULL),
('c9d0e1f2-a3b4-5678-cd89-012345678901', 'Route 22', 'route-22', 83, 'route', true, false, false, NULL),
('c9d0e1f2-a3b4-5678-cd89-012345678901', 'Route 28', 'route-28', 84, 'route', true, false, false, NULL),
('c9d0e1f2-a3b4-5678-cd89-012345678901', 'Mt. Silver', 'mt-silver', 85, 'cave', true, false, true, 'Red awaits at the summit.'),
('c9d0e1f2-a3b4-5678-cd89-012345678901', 'Bell Tower', 'bell-tower', 86, 'building', true, false, false, 'Ho-Oh (HeartGold).'),
('c9d0e1f2-a3b4-5678-cd89-012345678901', 'Cerulean Cave', 'cerulean-cave', 87, 'cave', true, false, true, 'Mewtwo. Post-game dungeon.'),
('c9d0e1f2-a3b4-5678-cd89-012345678901', 'Safari Zone', 'safari-zone', 88, 'special', true, false, false, 'HGSS Safari Zone near Cianwood.'),
('c9d0e1f2-a3b4-5678-cd89-012345678901', 'Route 47', 'route-47', 89, 'route', true, true, false, NULL),
('c9d0e1f2-a3b4-5678-cd89-012345678901', 'Route 48', 'route-48', 90, 'route', true, true, false, NULL);
...
FROM public.routes r WHERE r.slug = 'new-bark-town' AND r.game_id = 'c9d0e1f2-a3b4-5678-cd89-012345678901';
...
-- ===========================================
-- STEP 4: ENCOUNTER DATA (1311 total)
-- ===========================================
...
('route-29', 19, 'walking', 10.00, 2, 2, 'Night', NULL),
('route-29', 19, 'walking', 5.00, 4, 4, NULL, NULL),
...
('route-30', 10, 'walking', 35.00, 3, 4, 'Day', NULL),
('route-30', 11, 'walking', 10.00, 4, 4, 'Morning', NULL),
('route-30', 11, 'walking', 15.00, 4, 4, 'Day', NULL),
('route-30', 16, 'walking', 40.00, 2, 4, 'Morning', NULL),
('route-30', 16, 'walking', 50.00, 2, 4, 'Day', NULL),
...
('route-30', 163, 'walking', 30.00, 4, 4, 'Night', NULL),
('route-30', 167, 'walking', 30.00, 2, 2, 'Night', NULL),
('route-30', 264, 'walking', 20.00, 4, 4, 'Hoenn Sound', NULL),
('route-30', 293, 'walking', 20.00, 2, 3, 'Hoenn Sound', NULL),
('route-30', 399, 'walking', 20.00, 4, 4, 'Sinnoh Sound', NULL),
('route-30', 418, 'walking', 20.00, 2, 3, 'Sinnoh Sound', NULL),
('route-31', 10, 'walking', 35.00, 4, 5, 'Morning', NULL),
('route-31', 10, 'walking', 35.00, 4, 5, 'Day', NULL),
('route-31', 11, 'walking', 15.00, 5, 5, 'Morning', NULL),
('route-31', 11, 'walking', 15.00, 5, 5, 'Day', NULL),
('route-31', 16, 'walking', 30.00, 3, 3, 'Morning', NULL),
('route-31', 16, 'walking', 30.00, 3, 3, 'Day', NULL),
...
('route-31', 167, 'walking', 30.00, 3, 3, 'Night', NULL),
('route-31', 264, 'walking', 20.00, 3, 3, 'Hoenn Sound', NULL),
('route-31', 293, 'walking', 20.00, 3, 4, 'Hoenn Sound', NULL),
('route-31', 399, 'walking', 20.00, 3, 3, 'Sinnoh Sound', NULL),
('route-31', 418, 'walking', 20.00, 3, 4, 'Sinnoh Sound', NULL),
...
('route-32', 19, 'walking', 30.00, 4, 4, NULL, NULL),
...
('union-cave', 19, 'walking', 20.00, 4, 20, NULL, NULL),
('union-cave', 27, 'walking', 60.00, 6, 8, NULL, NULL),
...
('union-cave', 131, 'static', 100.00, 20, 20, 'weekday-friday, other-event-arceus-in-party', NULL),
...
('route-33', 19, 'walking', 40.00, 6, 7, NULL, NULL),
...
('ilex-forest', 10, 'walking', 50.00, 5, 6, 'Morning', NULL),
('ilex-forest', 10, 'walking', 60.00, 5, 6, 'Day', NULL),
('ilex-forest', 11, 'walking', 30.00, 6, 6, 'Morning', NULL),
('ilex-forest', 11, 'walking', 30.00, 5, 6, 'Day', NULL),
...
('national-park', 10, 'walking', 50.00, 10, 12, 'Morning', NULL),
('national-park', 10, 'walking', 30.00, 10, 10, 'Day', NULL),
('national-park', 11, 'walking', 30.00, 10, 10, 'Morning', NULL),
('national-park', 11, 'walking', 30.00, 10, 10, 'Day', NULL),
...
('route-36', 16, 'walking', 25.00, 13, 15, 'Morning', NULL),
('route-36', 16, 'walking', 20.00, 13, 13, 'Day', NULL),
('route-36', 29, 'walking', 30.00, 12, 12, NULL, NULL),
('route-36', 32, 'walking', 30.00, 12, 12, NULL, NULL),
('route-36', 58, 'walking', 10.00, 13, 13, NULL, NULL),
('route-36', 58, 'walking', 5.00, 15, 15, 'Day', NULL),
...
('route-37', 16, 'walking', 60.00, 13, 15, 'Morning', NULL),
('route-37', 16, 'walking', 50.00, 13, 15, 'Day', NULL),
('route-37', 17, 'walking', 5.00, 15, 15, 'Day', NULL),
('route-37', 58, 'walking', 10.00, 14, 14, NULL, NULL),
('route-37', 58, 'walking', 5.00, 15, 15, 'Day', NULL),
('route-37', 163, 'walking', 20.00, 15, 15, 'Night', NULL),
('route-37', 167, 'walking', 40.00, 13, 15, 'Night', NULL),
...
('route-38', 19, 'walking', 30.00, 16, 16, NULL, NULL),
('route-38', 19, 'walking', 10.00, 16, 16, 'Night', NULL),
...
('route-39', 19, 'walking', 30.00, 16, 16, NULL, NULL),
('route-39', 19, 'walking', 10.00, 16, 16, 'Night', NULL),
...
('route-41', 226, 'surfing', 10.00, 15, 25, NULL, NULL),
('route-42', 21, 'walking', 30.00, 14, 16, 'Morning', NULL),
('route-42', 21, 'walking', 30.00, 14, 16, 'Day', NULL),
('route-42', 41, 'walking', 30.00, 14, 16, 'Night', NULL),
('route-42', 56, 'walking', 30.00, 15, 15, NULL, NULL),
...
('route-42', 179, 'walking', 30.00, 13, 13, NULL, NULL),
('route-42', 180, 'walking', 10.00, 15, 17, NULL, NULL),
('route-42', 264, 'walking', 20.00, 14, 14, 'Hoenn Sound', NULL),
('route-42', 293, 'walking', 20.00, 13, 15, 'Hoenn Sound', NULL),
('route-42', 399, 'walking', 20.00, 14, 14, 'Sinnoh Sound', NULL),
('route-42', 418, 'walking', 20.00, 13, 15, 'Sinnoh Sound', NULL),
...
('ice-path', 41, 'walking', 80.00, 22, 23, NULL, NULL),
...
('route-45', 75, 'walking', 40.00, 23, 27, NULL, NULL),
...
('route-45', 207, 'walking', 20.00, 24, 24, NULL, NULL),
('route-45', 231, 'walking', 10.00, 20, 20, NULL, NULL),
...
('whirl-islands', 249, 'static', 100.00, 70, 70, NULL, NULL),
('route-27', 20, 'walking', 40.00, 28, 30, NULL, NULL),
('route-27', 28, 'walking', 5.00, 30, 30, NULL, NULL),
...
('route-27', 84, 'walking', 50.00, 28, 30, 'Morning', NULL),
('route-27', 84, 'walking', 50.00, 28, 30, 'Day', NULL),
...
('route-27', 195, 'walking', 50.00, 28, 30, 'Night', NULL),
...
('route-26', 28, 'walking', 30.00, 28, 28, NULL, NULL),
...
('route-26', 84, 'walking', 40.00, 28, 30, 'Morning', NULL),
('route-26', 84, 'walking', 40.00, 28, 30, 'Day', NULL),
('route-26', 85, 'walking', 5.00, 30, 30, 'Morning', NULL),
('route-26', 85, 'walking', 5.00, 30, 30, 'Day', NULL),
...
('route-6', 16, 'walking', 50.00, 13, 14, 'Morning', NULL),
('route-6', 16, 'walking', 50.00, 13, 14, 'Day', NULL),
('route-6', 43, 'walking', 60.00, 13, 13, 'Night', NULL),
...
('route-5', 16, 'walking', 60.00, 13, 15, 'Morning', NULL),
('route-5', 16, 'walking', 60.00, 13, 15, 'Day', NULL),
('route-5', 43, 'walking', 60.00, 13, 13, 'Night', NULL),
...
('route-9', 19, 'walking', 30.00, 15, 15, NULL, NULL),
('route-9', 19, 'walking', 10.00, 15, 15, 'Night', NULL),
...
('route-9', 21, 'walking', 20.00, 13, 13, 'Morning', NULL),
('route-9', 21, 'walking', 20.00, 13, 13, 'Day', NULL),
('route-9', 22, 'walking', 5.00, 15, 15, 'Morning', NULL),
('route-9', 22, 'walking', 5.00, 15, 15, 'Day', NULL),
('route-9', 56, 'walking', 30.00, 13, 13, NULL, NULL),
('route-9', 57, 'walking', 5.00, 15, 15, NULL, NULL),
...
('route-9', 302, 'walking', 40.00, 13, 15, 'Swarm', NULL),
...
('route-8', 17, 'walking', 65.00, 17, 19, 'Morning', NULL),
('route-8', 17, 'walking', 65.00, 17, 19, 'Day', NULL),
('route-8', 58, 'walking', 10.00, 18, 18, 'Morning', NULL),
('route-8', 58, 'walking', 10.00, 18, 18, 'Day', NULL),
('route-8', 58, 'walking', 5.00, 17, 17, 'Night', NULL),
('route-8', 63, 'walking', 20.00, 15, 15, NULL, NULL),
('route-8', 64, 'walking', 5.00, 15, 15, NULL, NULL),
('route-8', 93, 'walking', 30.00, 19, 19, 'Night', NULL),
('route-8', 164, 'walking', 40.00, 17, 18, 'Night', NULL),
...
('route-7', 19, 'walking', 30.00, 17, 17, NULL, NULL),
('route-7', 19, 'walking', 10.00, 15, 19, 'Morning', NULL),
('route-7', 19, 'walking', 5.00, 19, 19, 'Day', NULL),
...
('route-7', 58, 'walking', 20.00, 18, 18, NULL, NULL),
('route-7', 58, 'walking', 5.00, 15, 15, 'Day', NULL),
('route-7', 198, 'walking', 35.00, 17, 19, 'Night', NULL),
...
('route-2', 10, 'walking', 62.00, 3, 4, 'Morning', NULL),
('route-2', 10, 'walking', 62.00, 3, 4, 'Day', NULL),
('route-2', 11, 'walking', 40.00, 5, 5, 'Morning', NULL),
('route-2', 11, 'walking', 20.00, 5, 5, 'Day', NULL),
('route-2', 12, 'walking', 20.00, 7, 8, 'Morning', NULL),
('route-2', 16, 'walking', 60.00, 3, 3, 'Morning', NULL),
('route-2', 16, 'walking', 90.00, 3, 8, 'Day', NULL),
('route-2', 17, 'walking', 10.00, 7, 7, 'Morning', NULL),
('route-2', 17, 'walking', 18.00, 7, 10, 'Day', NULL),
('route-2', 163, 'walking', 100.00, 3, 5, 'Night', NULL),
('route-2', 164, 'walking', 28.00, 7, 10, 'Night', NULL),
('route-2', 167, 'walking', 62.00, 3, 4, 'Night', NULL),
('route-2', 167, 'walking', 8.00, 10, 10, 'Morning', NULL),
('route-2', 168, 'walking', 10.00, 7, 7, 'Night', NULL),
...
('route-2', 12, 'walking', 10.00, 7, 8, 'Day', NULL),
('viridian-forest', 10, 'walking', 40.00, 3, 3, 'Morning', NULL),
('viridian-forest', 10, 'walking', 40.00, 3, 3, 'Day', NULL),
('viridian-forest', 11, 'walking', 30.00, 3, 5, 'Morning', NULL),
('viridian-forest', 11, 'walking', 30.00, 3, 5, 'Day', NULL),
('viridian-forest', 12, 'walking', 10.00, 7, 7, 'Morning', NULL),
...
('route-28', 232, 'walking', 20.00, 40, 40, NULL, NULL),
...
('mt-silver', 232, 'walking', 110.00, 42, 48, NULL, NULL),
...
('mt-silver', 231, 'walking', 20.00, 43, 46, NULL, NULL),
...
('mt-silver', 247, 'walking', 5.00, 45, 45, NULL, NULL),
...
('cerulean-cave', 57, 'walking', 10.00, 38, 38, 'Morning', NULL),
('cerulean-cave', 57, 'walking', 10.00, 38, 38, 'Day', NULL),
('cerulean-cave', 57, 'walking', 4.00, 39, 39, NULL, NULL),
...
('route-48', 58, 'walking', 20.00, 25, 25, 'Night', NULL),
('route-48', 58, 'walking', 9.00, 21, 22, NULL, NULL),
('route-48', 83, 'walking', 20.00, 25, 25, 'Morning', NULL),
('route-48', 83, 'walking', 20.00, 25, 25, 'Day', NULL),
...
FROM _enc e JOIN public.routes r ON r.slug = e.slug AND r.game_id = 'c9d0e1f2-a3b4-5678-cd89-012345678901';
...
DECLARE
  ...
  v_route_id UUID;
BEGIN
  SELECT id INTO v_route_id FROM public.routes WHERE slug = 'violet-city' AND game_id = 'c9d0e1f2-a3b4-5678-cd89-012345678901';
...
DECLARE
  ...
  v_route_id UUID;
BEGIN
  SELECT id INTO v_route_id FROM public.routes WHERE slug = 'azalea-town' AND game_id = 'c9d0e1f2-a3b4-5678-cd89-012345678901';
  INSERT INTO public.trainers (route_id, name, trainer_class, is_boss, boss_type, level_cap, display_order, notes)
...
DECLARE
  ...
  v_route_id UUID;
BEGIN
  SELECT id INTO v_route_id FROM public.routes WHERE slug = 'goldenrod-city' AND game_id = 'c9d0e1f2-a3b4-5678-cd89-012345678901';
  INSERT INTO public.trainers (route_id, name, trainer_class, is_boss, boss_type, level_cap, display_order, notes)
...
DECLARE
  ...
  v_route_id UUID;
BEGIN
  SELECT id INTO v_route_id FROM public.routes WHERE slug = 'ecruteak-city' AND game_id = 'c9d0e1f2-a3b4-5678-cd89-012345678901';
  INSERT INTO public.trainers (route_id, name, trainer_class, is_boss, boss_type, level_cap, display_order, notes)
...
DECLARE
  ...
  v_route_id UUID;
BEGIN
  SELECT id INTO v_route_id FROM public.routes WHERE slug = 'cianwood-city' AND game_id = 'c9d0e1f2-a3b4-5678-cd89-012345678901';
  INSERT INTO public.trainers (route_id, name, trainer_class, is_boss, boss_type, level_cap, display_order, notes)
...
DECLARE
  ...
  v_route_id UUID;
BEGIN
  SELECT id INTO v_route_id FROM public.routes WHERE slug = 'olivine-city' AND game_id = 'c9d0e1f2-a3b4-5678-cd89-012345678901';
  INSERT INTO public.trainers (route_id, name, trainer_class, is_boss, boss_type, level_cap, display_order, notes)
...
DECLARE
  ...
  v_route_id UUID;
BEGIN
  SELECT id INTO v_route_id FROM public.routes WHERE slug = 'mahogany-town' AND game_id = 'c9d0e1f2-a3b4-5678-cd89-012345678901';
  INSERT INTO public.trainers (route_id, name, trainer_class, is_boss, boss_type, level_cap, display_order, notes)
...
DECLARE
  ...
  v_route_id UUID;
BEGIN
  SELECT id INTO v_route_id FROM public.routes WHERE slug = 'blackthorn-city' AND game_id = 'c9d0e1f2-a3b4-5678-cd89-012345678901';
  INSERT INTO public.trainers (route_id, name, trainer_class, is_boss, boss_type, level_cap, display_order, notes)
...
DECLARE
  ...
  v_route_id UUID;
BEGIN
  SELECT id INTO v_route_id FROM public.routes WHERE slug = 'indigo-plateau' AND game_id = 'c9d0e1f2-a3b4-5678-cd89-012345678901';
  INSERT INTO public.trainers (route_id, name, trainer_class, is_boss, boss_type, level_cap, display_order, notes)
...
DECLARE
  ...
  v_route_id UUID;
BEGIN
  SELECT id INTO v_route_id FROM public.routes WHERE slug = 'vermilion-city' AND game_id = 'c9d0e1f2-a3b4-5678-cd89-012345678901';
  INSERT INTO public.trainers (route_id, name, trainer_class, is_boss, boss_type, level_cap, display_order, notes)
...
DECLARE
  ...
  v_route_id UUID;
BEGIN
  SELECT id INTO v_route_id FROM public.routes WHERE slug = 'saffron-city' AND game_id = 'c9d0e1f2-a3b4-5678-cd89-012345678901';
  INSERT INTO public.trainers (route_id, name, trainer_class, is_boss, boss_type, level_cap, display_order, notes)
...
DECLARE
  ...
  v_route_id UUID;
BEGIN
  SELECT id INTO v_route_id FROM public.routes WHERE slug = 'cerulean-city' AND game_id = 'c9d0e1f2-a3b4-5678-cd89-012345678901';
  INSERT INTO public.trainers (route_id, name, trainer_class, is_boss, boss_type, level_cap, display_order, notes)
...
DECLARE
  ...
  v_route_id UUID;
BEGIN
  SELECT id INTO v_route_id FROM public.routes WHERE slug = 'celadon-city' AND game_id = 'c9d0e1f2-a3b4-5678-cd89-012345678901';
  INSERT INTO public.trainers (route_id, name, trainer_class, is_boss, boss_type, level_cap, display_order, notes)
...
DECLARE
  ...
  v_route_id UUID;
BEGIN
  SELECT id INTO v_route_id FROM public.routes WHERE slug = 'fuchsia-city' AND game_id = 'c9d0e1f2-a3b4-5678-cd89-012345678901';
  INSERT INTO public.trainers (route_id, name, trainer_class, is_boss, boss_type, level_cap, display_order, notes)
...
DECLARE
  ...
  v_route_id UUID;
BEGIN
  SELECT id INTO v_route_id FROM public.routes WHERE slug = 'pewter-city' AND game_id = 'c9d0e1f2-a3b4-5678-cd89-012345678901';
  INSERT INTO public.trainers (route_id, name, trainer_class, is_boss, boss_type, level_cap, display_order, notes)
...
DECLARE
  ...
  v_route_id UUID;
BEGIN
  SELECT id INTO v_route_id FROM public.routes WHERE slug = 'cinnabar-island' AND game_id = 'c9d0e1f2-a3b4-5678-cd89-012345678901';
  INSERT INTO public.trainers (route_id, name, trainer_class, is_boss, boss_type, level_cap, display_order, notes)
...
DECLARE
  ...
  v_route_id UUID;
BEGIN
  SELECT id INTO v_route_id FROM public.routes WHERE slug = 'viridian-city' AND game_id = 'c9d0e1f2-a3b4-5678-cd89-012345678901';
  INSERT INTO public.trainers (route_id, name, trainer_class, is_boss, boss_type, level_cap, display_order, notes)
...
UPDATE public.games SET total_routes = 90 WHERE id = 'c9d0e1f2-a3b4-5678-cd89-012345678901';
